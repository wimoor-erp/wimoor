...
public class AmazonAuthorityController {
	 ...
	 private final IWareHouseFBAService wareHouseFBAService;
	    ...
	    public Result<String> getUrlAction(String groupid,String marketplaceid,String redirecturl) {
	    	String result=iAmazonAuthorityService.getAuthUrl(groupid,marketplaceid,redirecturl);
	        return Result.success(result);
	    }
