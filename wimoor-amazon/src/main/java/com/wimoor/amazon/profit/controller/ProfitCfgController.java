...
public class ProfitCfgController {
	...
	public Result<ProfitConfig> setConfigAction(@RequestBody ProfitConfig config) throws UserException {
	...
	public Result<ProfitConfig> findSysPlan(HttpServletRequest request) throws UserException {
	...
	@ResponseBody
	@ApiOperation(value = "查找系统方案")
	@GetMapping(value = "/findInplacefee")
	public Result<List<InplaceFee>> findInplacefee(String country) {
