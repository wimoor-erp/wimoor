...
public interface FBAFormatMapper  extends BaseMapper<FBAFormat> {
    FBAFormat findByProductTierId(@Param("productTierId")String productTierId, @Param("month")String month, @Param("country") String country);

	FBAFormat findByProductTierIdAndIsMedia(@Param("productTierId") String productTierId, @Param("country") String country,
			@Param("isMedia") Boolean isMedia, @Param("weight")BigDecimal weight);
	
	FBAFormat findByProductTierIdAndIsMedia2(@Param("productTierId")String productTierId, @Param("isMedia") Boolean isMedia, @Param("country") String country);
