...
//						 }
						 if(mskuParam.get("boxnum")!=null) {
							int num=new Integer(mskuParam.get("boxnum").toString());
							if(num>0) {
								boxnum=num;
							}
						 }
...
//  void 	setSummary(Map<String, Object> summary,String key,BigDecimal unit,Integer amount) {
//	  Object old = summary.get(key);
//		 if(old==null) {
//			 summary.put(key,unit.multiply(new BigDecimal(amount)));
//		 }else {
//			 summary.put(key,new BigDecimal(old.toString()).add(unit.multiply(new BigDecimal(amount))));
//		 }
//  }
