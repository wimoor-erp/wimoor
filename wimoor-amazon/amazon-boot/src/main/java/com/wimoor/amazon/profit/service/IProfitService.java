...
public interface IProfitService {
	...
	public String determineSmlProductTier(String country, InputDimensions inputDimension,
			ProfitConfigCountry profitConfigX);

	public BigDecimal calculateSmlFBA(String country, String productTierId, BigDecimal outboundWeight,ProfitConfigCountry profitConfigX);
