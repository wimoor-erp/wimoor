...
public class ProductInOptController {
    ...
    @PostMapping("/updateOptOwner/{owner}")
   	public Result<String> updateOptOwnerAction(@PathVariable("owner") String owner,@RequestBody List<String> pidlist) {
    	iProductInOptService.updateOptOwner(owner,pidlist);
    	return Result.success("ok");
   	}
