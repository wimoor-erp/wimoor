...
public class AmzOrderMainServiceImpl extends ServiceImpl<AmzOrderMainMapper,AmzOrderMain> implements IAmzOrderMainService,IAwsSQSMessageHandlerService {
	...
	public boolean handlerMessage(JSONObject body) {
		// TODO Auto-generated method stub
		JSONObject OrderChangeNotification = body.getJSONObject("OrderChangeNotification");
		...
		String marketplaceId=summary.getString("MarketplaceId");
		Date purchaseDate=summary.getDate("PurchaseDate");
		String orderStatus=summary.getString("OrderStatus");
		String destinationPostalCode=summary.getString("DestinationPostalCode");
		String fulfillmentType=summary.getString("FulfillmentType");
