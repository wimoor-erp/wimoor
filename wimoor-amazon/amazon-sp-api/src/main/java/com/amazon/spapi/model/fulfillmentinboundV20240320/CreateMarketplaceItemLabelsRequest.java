...
public class CreateMarketplaceItemLabelsRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The Marketplace ID. Refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a list of possible values.")
