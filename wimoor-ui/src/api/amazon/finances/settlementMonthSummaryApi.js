...
function downloadListOld(data,callback){
	return request({url:"/amazon/api/v1/settlementSummarySkuMonth/downloadListOld",
		responseType:"blob",
		data:data,
		method:'post'}).then(res => {
		downloadhandler.downloadSuccess(res,"AmzFinSettmentMonthFeeReport.xlsx");
...
export default{
 	list,downloadList,getRefreshData,downloadListOld
 }