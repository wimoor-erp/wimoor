 ...
 function getList(data){
	 return request.post("/amazon/api/v1/settlement/getList",data);
 }
...
function selectSettlementOpen(data){
 ...
 function downloadList(data,callback){
	 return request({url:"/amazon/api/v1/settlement/downloadList",
		 responseType:"blob",
		 data:data,
		 method:'post'}).then(res => {
 ...
 export default{
	...
	deleteAmzSettlementAccStatement,selectSettlementOpen,downloadSettlementOpen,getList,downloadList,
 }