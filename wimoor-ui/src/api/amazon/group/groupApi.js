...
function getGroupInfo(groupid){
	return request.get('/amazon/api/v1/amzgroup/info/'+groupid);
}
function saveGroupInfo(data){
	return request.post('/amazon/api/v1/amzgroup/info/save',data);
}

export default{
	AmazonGroupSave,getAmazongroupList,deleteAmazongroup,getAmazonGroup,updateBatch,getAmazonGroupById,selectTaskInfoList,getGroupInfo,saveGroupInfo,	
}