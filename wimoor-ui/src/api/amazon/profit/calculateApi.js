...
function dataAnalysisSingle(data){
	return request.get('/amazon/api/v1/report/dataAnalysisSingle',{params:data});
}
export default{
	showProfitDetial,showProfitPage,showCost,showProfit,inplacefee,dataAnalysisSingle
}