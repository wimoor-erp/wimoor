...
function downloadPurchaseInfoData(data){
	return request.post('/erp/api/v1/purchase_form/downloadPurchaseInfoData',data);
}
...
export default{
	 ...
	 approval,purchaseReturn,updateNotice,receive,clearRec,downExcelReports,paymentApply,
