...
function saveTransTrace(data){
 ...
 function updateShipmentTranStyle(data){
		return request.get('/amazon/api/v2/shipInboundPlan/shipment/updateShipmentTranStyle',{params:data});
 }
...
export default{
	 ...
	 saveshipments,toQuote,ignoreShipment,saveDestinationBox,listDestination,updateShipmentTranStyle
}