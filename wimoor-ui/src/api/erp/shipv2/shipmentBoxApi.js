...
function downExcelBoxCaseTemp(data,name,callback){
	return request({url:"/amazon/api/v2/shipInboundPlan/box/downExcelBoxCaseTemp",
		responseType:"blob",
		data:data,
...
export default{
	 generatePackingOptions,listPackingOptions,listPackingGroupItems,savePackingInformation,downExcelBoxCaseTemp,
