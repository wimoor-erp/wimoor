...
function approveAndKeepInboundPlan(data){
	return request.get('/amazon/api/v2/shipInboundPlan/approveAndKeepInboundPlan',{params:data });
}
...
function downExcelBoxDetail(data){
	return request({url:"/amazon/api/v2/shipInboundPlan/box/downExcelBoxDetail",
		responseType:"blob",
		params:data,
		method:'get'});
}
...
function uploadExcelBoxDetail(FormData){
	return request({'method':'POST',
		'url':"/amazon/api/v2/shipInboundPlan/box/uploadExcelBoxDetail",
		'data':FormData,
		'headers':{'Content-Type':"multipart/form-data"},
	});
}

function uploadShipmentExcelBoxDetail(FormData){
	return request({'method':'POST',
		'url':"/amazon/api/v2/shipInboundPlan/box/uploadShipmentExcelBoxDetail",
		'data':FormData,
		'headers':{'Content-Type':"multipart/form-data"},
	});
}
...
function updatePlanTranStyle(data){
	return request.get('/amazon/api/v2/shipInboundPlan/updatePlanTranStyle',{params:data});
}
...
function releaseKeepInboundPlan(data){
	return request.post('/amazon/api/v2/shipInboundPlan/releaseKeepInboundPlan',data);
}

export default{
	 saveInboundPlan,approveInboundPlan,approveAndKeepInboundPlan,rejectInboundPlan,getPlanList,
	 ...
	 downExcelBoxDetail,uploadExcelBoxDetail,uploadShipmentExcelBoxDetail,updatePlanTranStyle,
	 releaseKeepInboundPlan,
