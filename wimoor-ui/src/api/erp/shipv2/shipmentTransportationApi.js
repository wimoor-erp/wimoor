...
function saveCustomList(data) {
	return request.post("/amazon/api/v2/shipInboundPlan/transportation/saveCustomList", data);
}
function getCustomList(data) {
	return request.get("/amazon/api/v2/shipInboundPlan/transportation/getCustomList", { params: data });
}
...
export default {
	...
	saveSelfTrans, getSelfTransHis, getCustomsList, saveCustomsList,
	saveTransCompany, saveTransportationNeedInfo, saveConfirmTransportationOptionsInfo,
	confirmTransportationOptionsByForm, getCustomList, saveCustomList,
