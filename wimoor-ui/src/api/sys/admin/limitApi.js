...
function updateLimit(data) {
   return request.post('/admin/api/v1/managerLimit/update' ,data);
}
function updateRemark(data) {
	return request.post('/admin/api/v1/managerLimit/updateRemark' ,data);
}
...
export default{
	...
	getMyManagerLimitmeal,updateLimit,updateRemark,
}