<template>
    <div class="app-container">
      ...
      <reportBalance v-if="activeName==='BALANCE_SHEET_STANDARD'"></reportBalance>
      <reportIncome v-else-if="activeName==='INCOME_STATEMENT_STANDARD'"></reportIncome>
      <reportCashflow v-else-if="activeName==='CASH_FLOW_STANDARD'"></reportCashflow>
      <reportEquity v-else-if="activeName==='EQUITY_CHANGE_STANDARD'"></reportEquity>
      <report-sheet v-else :type="activeName"></report-sheet>
...
import reportBalance from './components/report_balance.vue';
import reportIncome from './components/report_income.vue';
import reportCashflow from './components/report_cashflow.vue';
import reportEquity from './components/report_equity.vue';
