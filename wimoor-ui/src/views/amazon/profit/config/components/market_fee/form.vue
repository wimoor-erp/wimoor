<template>
	...
	<el-form-item v-if="country=='EU'" label="VAT增值税费率" >
      ...
      <el-col :span="8" class="paddingleft10">
        <span class="font-extraSmall">爱尔兰(IE) </span>
        <el-input  @input="countryMapData.IE.vatRate=CheckInputFloat(countryMapData.IE.vatRate)"
                   v-model="countryMapData.IE.vatRate"> <template #append>% </template></el-input>
      </el-col>
			 </el-row>
	</el-form-item>  
