			...
			<el-col  :span="7" class="el-white-bg">
               ...
               <span class="font-extraSmall">kg体积重:{{formData.kgVolume}}</span>
                 ...
                 <p>美国售价范围，不大于10美元</p>
							   <p>加拿大售价范围，不大于14加元</p>
							   <p>英国售价范围，不大于20英镑</p>
							   <p>德国,法国,意大利,荷兰,西班牙,比利时,爱尔兰 售价范围，不大于20欧元</p>
							   <p>瑞典售价范围，不大于230克朗</p>
							   <p>波兰售价范围，不大于85波兰兹罗提</p>
                 <p>美妆/个护健康/商业工业/科研/办公/食品美食/图书/亚马逊设备配件/厨房品类下:</p>
                 <p>英国售价范围，不大于10英镑</p>
                 <p>德国售价范围，不大于11欧元</p>
							   <p>法国,意大利,荷兰,西班牙,比利时,爱尔兰 售价范围，不大于12欧元</p>
							   <p>瑞典售价范围，不大于140克朗</p>
...
function getLbVolume(length,width,height){
  if((length * width * height) / 139>0){
    return ((length * width * height) / 139).toFixed(2);
  }else{
    return '--';
  }
}
  function getKgVolume(length,width,height){
    if((length * width * height) / 5000>0){
