	                   ...
	                   <el-collapse class="collapse-card" v-model="activeCard" @change="handleChange">
							<el-collapse-item title="Consistency" :name="1">
								 <template #title>
									...
									<el-space :size="2"  @click.stop="handleEmpty"  v-if="country.market=='IN'" style="margin-top: 15px;">
									...
									<el-space :size="2"  v-if="country.market=='IN'" @click.stop="handleEmpty"  style="margin-top: 15px;">
										 <el-divider direction="vertical" />
