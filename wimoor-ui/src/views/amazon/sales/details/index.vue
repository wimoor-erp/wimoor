		...
		<div class="con-header">
			<el-row >
				<el-space>
					...
					<el-select v-model="queryParam.summaryType" @change="searchConfirm" style="width: 150px;">
          ...
          <el-select v-model="queryParam.summaryData" @change="searchConfirm" style="width: 100px;">
            <el-option label="销量" key="quantity" value="quantity"></el-option>
            <el-option label="订单" key="orders" value="orders"></el-option>
          </el-select>
...
<script setup>
	...
	let state = reactive({queryParam:{search:"",summaryType:"day",summaryData:"quantity"},fieldOptions:[],
