<template>
	<div class="main-sty" >
		<div class="con-header">
			<el-row>
				<Group @change="getGroup" isproduct="ok" :init="true" ref="groupRef" />
				<el-space>
			...
			<el-row>
				<el-space >
				    ...
				    <el-button type="primary" @click.stop="downloadList">导出</el-button>
						<div class="font-extraSmall">此功能只支持英国</div>
					</el-space>
...
<script>
	...
	import Group from '@/views/amazon/listing/common/group_only.vue';
	...
	export default {
		...
		function getGroup(obj){
			...
			queryParam.marketplaceid="A1F83G8C2ARO7P";
