	...
	<div   class="main-sty">
		<el-tabs v-model="selectable"  @tab-change="handleQuery">
		  ...
		  <el-row>
            ...
            <el-select v-model="queryParam.datetype" style="width:120px"  @change="handleQuery" placeholder="选择日期类型">
              <el-option label="发货日期" value="shipdate" />
              <el-option label="到货日期" value="arrdate" />
            </el-select>
				  <Datepicker longtime="ok" ref="datepickers" style="width:250px" @changedate="changedate" />
