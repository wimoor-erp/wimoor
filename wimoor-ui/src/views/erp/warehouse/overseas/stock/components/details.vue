<template>
	<div class="el-white-bg" style="padding-bottom:20px" id="overseasPrintArea">
		
						 <div class="gird-line-head">
						 <h3>海外仓备货单</h3>
						 <div>
               <el-space>
                 <PrinterBtn printId="overseasPrintArea"  title="海外仓备货单详情" />
                 <Helper name="海外仓-备货单" />
               </el-space>
						...
						<div style="padding-top:20px;">
						     ...
						     <el-tab-pane label="调库商品 " name="调库商品">
								 <el-row>
										...
										<el-col :span="2">
											...
											<el-col :span="2">
											  <el-link title="下架配货" :disabled="warehouseform.check_inv"  class="icon-text-center" :underline="false" @click="handleDownShelf()">
												<send-backward theme="outline" size="16" class="text-blue" :strokeWidth="2"/>&nbsp;下架配货
											  </el-link>
										</el-col>
										<el-col :span="2">
                         ...
                         <el-link type="success" @click.stop="downloadBoxDetail(warehouseform)">  下载装箱信息</el-link>
										   </div>
									</div>
								 </el-tab-pane>
						   </el-tabs>
...
<script setup>
	import {Plus,Minus,Help,Printer,AddPrint,InboxOut,SendBackward} from '@icon-park/vue-next';
  ...
  function downloadBoxDetail(){
    dispatchApi.downExcelBoxDetail({id:state.warehouseform.id});
  }
	...
	function handleDownShelf(){
		router.push({
			path:'/erp/ship/quota',
			query:{
			  overseasformid:state.warehouseform.id,
			  title:"配货单下架",
			  path:'/erp/ship/quota',
			}
		})
