<template>
	<div class="el-white-bg">
		 <el-scrollbar class="he-scr-car" @scroll="scroll"  id="inboundPrintArea">
		 						 <div class="gird-line-head">
		 						 <h3>入库单详情</h3>
                   <el-space>
                   <PrinterBtn printId="inboundPrintArea" title="入库单详情" />
                   <Helper name="入库单" />
                   </el-space>
		 						 </div>
...
<script setup>
	...
	import {ArrowDown,Edit,View,Upload} from '@element-plus/icons-vue';
