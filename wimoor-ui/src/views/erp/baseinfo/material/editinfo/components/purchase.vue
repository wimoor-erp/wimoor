<template>
	...
	<el-row>
		...
		<el-col :span="6">
			<el-form-item label="增值税税率" v-if="type=='product'"  width="100">
		 ...
		 <el-col :span="6">
			<el-form-item label="退税率" v-if="type=='product'"  width="100">
				<el-input v-model="dataBaseForms.drawbackRate" @input="dataBaseForms.drawbackRate=CheckInputFloat(dataBaseForms.drawbackRate)"  placeholder="为空不含税">
					  <template #append>%</template>
				</el-input>
			</el-form-item>
		</el-col>
