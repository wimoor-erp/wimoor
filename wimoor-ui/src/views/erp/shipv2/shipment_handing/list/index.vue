<template>
	<div class="main-sty">
	    ...
	    <Table :needTab="true" ref="tableRef"  @change="handleTableChange" @customsChange="handleCustomsChange"/>
	</div>
</template>
...
<script setup>
    ...
    obj.shipmentids=data.shipmentids;
	...
	function handleCustomsChange(data){
		headerRef.value.handleCustomsChange(data);
	}
</script>
