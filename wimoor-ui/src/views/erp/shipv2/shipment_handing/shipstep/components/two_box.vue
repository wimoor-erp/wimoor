	...
	<div class="box-ship">
			<el-row>
				<el-col :span="6" >
                  ...
                  <template #label>
                    <el-space>
                      <div>预计到货时间</div>
                      <el-button :loading="genloading"   @click="handleRegenerate" size="small">重新生成</el-button>
                    </el-space>
                  </template>
									<el-space>
		...
		<div class="con-body"  >
			<div style="width:100%;overflow-x: auto;margin-bottom:10px;">
			   ...
			   <ShipBox ref="shipBoxRef" @change="handleChange" v-else :isview="true"></ShipBox>
			</div>
		</div>
...
<script setup>
 ...
 function handleRegenerate(){
   let param={"formid":state.planData.plan.id,"shipmentId":state.planData.shipment.shipmentid};
