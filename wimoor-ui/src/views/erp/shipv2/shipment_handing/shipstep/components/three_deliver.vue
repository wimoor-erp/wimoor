	...
	<div class="transportation-wrap">
		<el-row :gutter="16">
			...
			<el-col :span="12"  >
              ...
              <template #header>
               <el-space> 尺寸(cm)材积
                 <el-select   @change="updateShipmentTranStyle(shipdata.transtyle)" v-model="shipdata.transtyle" placeholder="货件类型" style="width: 120px" size="small">
...
<script setup>
  ...
  function updateShipmentTranStyle(transtyle){
    shipmenthandlingV2Api.updateShipmentTranStyle({"shipmentid":shipInfoAll.shipmentid,"transtyle":transtyle}).then((res)=>{
      if(res.data){
