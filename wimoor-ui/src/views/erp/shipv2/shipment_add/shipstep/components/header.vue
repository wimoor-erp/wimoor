	...
	<el-row>
	    <el-col :span="12" >
		  ...
		  <div  style="font-size: 14px;padding-top:4px">
			   ...
			   <span v-if="step==1"> 第 2 步：商品装箱打包<el-button style="margin-left: 20px;" size="small" type="primary" plain @click="donePlanBox" v-if="step==1&&!planData.submitbox">跳过装箱(仅LTL,先分票后装箱)</el-button>
          <span class="font-extraSmall" style="padding-left: 8px;">跳过装箱请不要在第2步填写箱子信息！</span>
         </span>
