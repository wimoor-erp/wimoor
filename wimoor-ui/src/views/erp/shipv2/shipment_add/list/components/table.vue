			...
			<template #field>
				...
				<el-table-column v-if="auditstatus==null" prop="auditstatus" label="状态" width="130"   >
					<template #default="scope">
						 ...
						 <el-tag v-if="scope.row.auditstatus==10" type="success">已保持</el-tag>
				...
				<el-table-column prop="remark" label="操作" width="130"   >
					<template #default="scope">
						<el-space>
							...
							<el-button v-else-if="scope.row.auditstatus>10 " class='el-button--blue' @click="gotoNewInbound(scope.row)">跟踪发货</el-button>
...
<script setup>
  ...
  import {Refresh,} from '@element-plus/icons-vue'
		...
		function selectChange(rows){
				emit("change",rows, auditstatus.value);
		}
