...
import { isDark } from "@/components/composables/dark";
export default{
	 name: 'Salechart',
	 props:["parameter"],
	 setup(prop,context){
	 ...
	 function loadChartData(){
		 		  ...
		 		  summaryDataApi.queryChartSales(queryParam).then(async (res)=>{
		 			...
		 			summaryDataApi.queryChartSalesSummary(queryParam).then(async (res)=>{ 
		 				let mres=await summaryDataApi.queryChartReturnSummary(queryParam);
