...
/* 暗黑模式 */
:global(html.dark) .rendered-content :deep(.code-block-wrapper) {
  border-color: #2a2a3e;
}

:global(html.dark) .rendered-content :deep(.code-header) {
  border-color: #2a2a3e;
  background: #1a1a2e;
}

:global(html.dark) .rendered-content :deep(.copy-hint) {
  color: #808090;
}

:global(html.dark) .rendered-content :deep(h1) {
  border-color: #2a2a3e;
}

:global(html.dark) .rendered-content :deep(:not(pre) > code) {
  background: #252538;
  border-color: #2a2a3e;
  color: #e0e0e0;
}
