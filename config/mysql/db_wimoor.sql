...
CREATE TABLE IF NOT EXISTS `t_amazonseller_market` (
  ...
  `domain` char(50)  DEFAULT NULL COMMENT '对应域名',
...
) ENGINE=InnoDB    COMMENT='授权对应区域客户所有绑定的站点';
...
CREATE TABLE IF NOT EXISTS `t_amazon_auth_market_performance` (
  ...
  `accountstatus` varchar(20)  NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `t_amz_adv_operate_log` (
  ...
  KEY `adGroupId` (`adGroupId`),
  KEY `profileid` (`profileid`,`opttime`)
) ENGINE=InnoDB AUTO_INCREMENT=319741   ;
...
CREATE TABLE IF NOT EXISTS `t_amz_adv_report_metrics` (
  ...
  `nomarket` varchar(245) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_adv_schedule_plan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=264    COMMENT='广告定时任务';
...
) ENGINE=InnoDB AUTO_INCREMENT=733     COMMENT='广告定时任务';
...
CREATE TABLE IF NOT EXISTS `t_amz_auth_api_timelimit` (
  ...
  `nexttoken` varchar(1000)  DEFAULT NULL COMMENT '是否有nexttoken',
...
-- 导出  表 db_plum.t_amz_group_distribution 结构
CREATE TABLE IF NOT EXISTS `t_amz_group_distribution` (
  `groupid` bigint unsigned DEFAULT NULL,
  `distribution` int unsigned DEFAULT NULL,
  `operator` bigint unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `creator` bigint unsigned DEFAULT NULL,
  `createtime` datetime DEFAULT NULL
) ENGINE=InnoDB    COMMENT='欧洲的发货方式，distribution：1代表统一配送，即发往欧洲的某个国家由亚马逊统一分配。0代表单独发货，即欧洲的每个国家单独发货';
...
CREATE TABLE IF NOT EXISTS `t_amz_inventory_planning` (
  ...
  `pending_removal_quantity` int DEFAULT NULL,
  `currency` char(5)  DEFAULT NULL,
  ...
  `qty_to_be_charged_ltsf_11_mo` int DEFAULT NULL,
  `projected_ltsf_11_mo` int DEFAULT NULL,
  `qty_to_be_charged_ltsf_12_mo` int DEFAULT NULL,
  `estimated_ltsf_next_charge` int DEFAULT NULL,
  `units_shipped_t7` int DEFAULT NULL,
  `units_shipped_t30` int DEFAULT NULL,
  `units_shipped_t60` int DEFAULT NULL,
  `units_shipped_t90` int DEFAULT NULL,
  `alert` varchar(50)  DEFAULT NULL,
  `your_price` decimal(20,6) DEFAULT NULL,
  `sales_price` decimal(20,6) DEFAULT NULL,
  `lowest_price_new_plus_shipping` decimal(20,6) DEFAULT NULL,
  `lowest_price_used` decimal(20,6) DEFAULT NULL,
  `recommended_action` varchar(50)  DEFAULT NULL,
  `healthy_inventory_level` int DEFAULT NULL,
  `recommended_sales_price` int DEFAULT NULL,
  `recommended_sale_duration_days` int DEFAULT NULL,
  `recommended_removal_quantity` int DEFAULT NULL,
  ...
  `volume_unit_measurement` varchar(50)  DEFAULT NULL,
  `storage_type` varchar(50)  DEFAULT NULL,
  `storage_volume` decimal(20,6) DEFAULT NULL,
  `product_group` varchar(50)  DEFAULT NULL,
  `sales_rank` int DEFAULT NULL,
  `days_of_supply` int DEFAULT NULL,
  `estimated_excess_quantity` int DEFAULT NULL,
  `weeks_of_cover_t30` int DEFAULT NULL,
  `weeks_of_cover_t90` int DEFAULT NULL,
  `featuredoffer_price` decimal(20,6) DEFAULT NULL,
  `sales_shipped_last_7_days` decimal(20,6) DEFAULT NULL,
  `sales_shipped_last_30_days` decimal(20,6) DEFAULT NULL,
  `sales_shipped_last_60_days` decimal(20,6) DEFAULT NULL,
  `sales_shipped_last_90_days` decimal(20,6) DEFAULT NULL,
  `inv_age_0_to_30_days` int DEFAULT NULL,
  `inv_age_31_to_60_days` int DEFAULT NULL,
  `inv_age_61_to_90_days` int DEFAULT NULL,
  `inv_age_181_to_330_days` int DEFAULT NULL,
  `inv_age_331_to_365_days` int DEFAULT NULL,
  `estimated_storage_cost_next_month` decimal(20,6) DEFAULT NULL,
  `inbound_quantity` int DEFAULT NULL,
  `inbound_working` int DEFAULT NULL,
  `inbound_shipped` int DEFAULT NULL,
  `inbound_received` int DEFAULT NULL,
  `no_sale_last_6_months` int DEFAULT NULL,
  `reserved_quantity` int DEFAULT NULL,
  `unfulfillable_quantity` int DEFAULT NULL,
  `afn_researching_quantity` int DEFAULT NULL,
  `afn_reserved_future_supply` int DEFAULT NULL,
  `afn_future_supply_buyable` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_orders_address` (
  ...
  KEY `amazonAuthid` (`amazonAuthid`,`marketplaceid`,`opttime`) USING BTREE
) ENGINE=InnoDB   ;

-- 数据导出被取消选择。

-- 导出  表 db_plum.t_amz_orders_archive 结构
...
CREATE TABLE IF NOT EXISTS `t_amz_orders_invoice_report` (
  ...
  `delivery_instructions` varchar(50) DEFAULT NULL,
  ...
  KEY `purchase_date_sales_channel_amazonAuthId` (`amazonAuthId`,`sales_channel`,`purchase_date`) USING BTREE
) ENGINE=InnoDB    ;
...
CREATE TABLE IF NOT EXISTS `t_amz_product_refresh` (
  ...
  KEY `amazonauthid_catalog_refresh_time_sku` (`amazonauthid`,`catalog_refresh_time`),
  KEY `amazonauthid_price_refresh_time_marketplaceid` (`amazonauthid`,`isparent`,`price_refresh_time`,`marketplaceid`) USING BTREE
) ENGINE=InnoDB  ;
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_inventory_country` (
  ...
  `refreshtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sku_country_authid` (`authid`,`sku`,`country`,`fcondition`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_erp_assembly_form` (
  ...
  `auditstatus` int DEFAULT NULL COMMENT '0：未提交，1：待组装，2 组装中，3 已完成，4 已终止5.已作废',
  `remark` varchar(500) DEFAULT NULL,
  `shopid` bigint unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=10591   COMMENT='用户维护日均销量表';
...
CREATE TABLE IF NOT EXISTS `t_erp_inventory_his_day` (
  ...
  KEY `shopid_materialid_byday` (`shopid`,`materialid`,`byday`)
) ENGINE=InnoDB   ;
...
CREATE TABLE IF NOT EXISTS `t_erp_material` (
  ...
  `operator` bigint unsigned DEFAULT NULL COMMENT '操作人',
  `opttime` datetime DEFAULT NULL COMMENT '操作时间',
  `price` decimal(10,2) DEFAULT NULL COMMENT '9.99',
  `price_ship_wavg` decimal(10,4) DEFAULT NULL COMMENT '10/100',
  `price_wavg` decimal(10,2) DEFAULT NULL COMMENT '9.99',
  `createdate` datetime DEFAULT NULL,
  `creator` bigint unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material_customs` (
  `matreialid` bigint unsigned DEFAULT NULL,
  `materialid` bigint unsigned DEFAULT NULL COMMENT '废弃id',
...
CREATE TABLE IF NOT EXISTS `t_erp_material_supplier_stepwise` (
  ...
  `materialid` bigint unsigned NOT NULL,
  `supplierid` bigint unsigned NOT NULL,
  `currency` char(10)  NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=1633291318889345026   ;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_message` (
  ...
  `signature` char(50) NOT NULL DEFAULT '',
  `opttime` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 ;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_productitems` (
  ...
  `skuInfos` varchar(100) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form` (
  ...
  `groupid` bigint unsigned DEFAULT NULL,
  `creator` bigint unsigned DEFAULT NULL COMMENT '创建人',
  `purchaser` bigint unsigned DEFAULT NULL COMMENT '采购员',
  `batch` char(36)  DEFAULT NULL COMMENT '批次',
...
) ENGINE=InnoDB AUTO_INCREMENT=17392024503393374547    COMMENT='FBA仓库配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=406172  ;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_planmodel` (
  ...
  KEY `groupid` (`groupid`,`warehouseid`)
) ENGINE=InnoDB   ;
...
) ENGINE=InnoDB AUTO_INCREMENT=20742   ;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transcompany` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index 2` (`shopid`,`isdelete`) USING BTREE
) ENGINE=InnoDB   ;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transdetail` (
  ...
  `oldid` char(36) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Index 2` (`company`,`marketplaceid`,`transtype`) USING BTREE
) ENGINE=InnoDB   ;
...
CREATE TABLE IF NOT EXISTS `t_erp_v3_purchase_plan` (
  ...
  `number` char(36) DEFAULT NULL,
  `creator` bigint unsigned DEFAULT NULL,
  `mincycle` int unsigned DEFAULT NULL,
  `shopid` bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_v3_purchase_plan_item` (
  ...
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `Index 2` (`planid`,`materialid`,`groupid`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_erp_v3_purchase_plan_item_history` (
  ...
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `Index 2` (`planid`,`materialid`,`warehouseid`,`batchnumber`,`groupid`) USING BTREE,
  KEY `materialid` (`materialid`) USING BTREE
) ENGINE=InnoDB    ;
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse` (
  ...
  `opttime` datetime DEFAULT NULL COMMENT '修改时间',
  `stocking_cycle` int DEFAULT '0' COMMENT '本地仓库备货周期',
  `disabled` bit(1) NOT NULL DEFAULT b'0',
  `isstocktaking` bit(1) DEFAULT b'0',
  `min_cycle` int DEFAULT '0' COMMENT '最小补货周期（补货频次）',
  `first_leg_charges` decimal(12,2) DEFAULT NULL COMMENT '海外仓头程费用',
  `oldid` char(36) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_shelf_inventory_opt_record` (
  ...
  `opttime` datetime DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `materialid` (`materialid`,`opttime`) USING BTREE,
  KEY `formid_formtype` (`formid`,`formtype`,`materialid`) USING BTREE,
  KEY `shelfid_materialid_shopid_formid_formtype` (`shopid`,`shelfid`,`materialid`) USING BTREE
...
) ENGINE=InnoDB AUTO_INCREMENT=452211   COMMENT='汇率';
...
) ENGINE=InnoDB AUTO_INCREMENT=132507  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=17441468  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=33809  ;
...
CREATE TABLE IF NOT EXISTS `t_orders_remark` (
  ...
  `review_send_operator` bigint unsigned DEFAULT NULL,
  `remark` varchar(255)  DEFAULT NULL COMMENT '客户给订单的备注',
  `operator` bigint unsigned DEFAULT NULL COMMENT '修改人',
  `opttime` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`amazon_order_id`),
  KEY `amazon_order_id_remark` (`remark`)
) ENGINE=InnoDB    COMMENT='订单备注';
...
CREATE TABLE IF NOT EXISTS `t_product_in_opt` (
  ...
  `businesstype` char(10)  DEFAULT NULL COMMENT '价格类型',
  `businesslist` varchar(1000)  DEFAULT NULL COMMENT '价格',
  ...
  `msku` varchar(100)  DEFAULT NULL COMMENT '本地SKU',
...
) ENGINE=InnoDB AUTO_INCREMENT=680  COMMENT='成本计算用，的亚马逊成本。采用父分类的方式，将所有国家的分类都放入此表。\r\n以美国的分类作为主要分类。如果美国没有此分类，则该分类依旧为美国添加，使用其他分类 类型的策略。\r\n当用户选择1 号分类，则其他子分类即改分类对应的其他国家的分类。\r\n ';
...
-- 导出  表 db_plum.t_role_taggroup 结构
...
) ENGINE=InnoDB AUTO_INCREMENT=1593091333478154242     COMMENT='字典类型表';
...
CREATE TABLE IF NOT EXISTS `t_sys_dict_item` (
  ...
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1628336451638321155     COMMENT='字典数据表';
...
CREATE TABLE IF NOT EXISTS `t_sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1573267937877839893     COMMENT='菜单管理';
...
CREATE TABLE IF NOT EXISTS `t_sys_menu_favorite` (
  ...
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20     COMMENT='菜单收藏';
...
) ENGINE=InnoDB AUTO_INCREMENT=483203   ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1648888789660286978     COMMENT='权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=123456944   ;
...
CREATE TABLE IF NOT EXISTS `t_sys_tags` (
  `id` bigint unsigned NOT NULL COMMENT 'ID',
  `name` varchar(500)  DEFAULT NULL COMMENT '标签名称',
  `value` varchar(500)  DEFAULT NULL,
  `sort` int DEFAULT NULL,
