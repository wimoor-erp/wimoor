...
public class AdvertPortfoliosController {
	...
	@ResponseBody
	@RequestMapping("/findPortfoliosForProfileId")
	public List<AmzAdvPortfolios> findPortfoliosForProfileIdAction(HttpServletRequest request, Model model) {
		...
		return amzAdvPortfoliosService.getPortfoliosForProfileId(param);
	}
