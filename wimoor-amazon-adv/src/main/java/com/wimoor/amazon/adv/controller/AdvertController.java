...
//		request.setAttribute("groupList", advGroupList);
	...
	public Object getProfileAction(HttpServletRequest request, Model model) {
	...
	public Result<Map<String,Object>> disableAuth(String groupid,String region) {
		UserInfo userinfo = UserInfoContext.get();
		Map<String, Object> result = amzAdvAuthService.updateAmzAdvAuthForDisable(userinfo.getCompanyid(), groupid, region);
