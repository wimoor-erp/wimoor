...
public interface AmzAdvKeywordsMapper extends BaseMapper<AmzAdvKeywords>{
	...
	PageList<Map<String, Object>> getKeywordsListForSB(Map<String, Object> map, PageBounds pageBounds);
	
	List<Map<String, Object>> getKeywordsListForSB(Map<String, Object> map);
