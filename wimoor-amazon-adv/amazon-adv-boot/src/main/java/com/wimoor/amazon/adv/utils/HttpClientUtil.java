...
public class HttpClientUtil {
	...
	public static String postUrl(String url, String param, Map<String, String> header, String type) throws BizException {
		HttpPost httpPost = null;
		CloseableHttpClient client = null;
		try {
			httpPost = new HttpPost(url);
	...
	public static String putUrl(String url, String param, Map<String, String> header, String type) throws BizException {
		HttpPut httpPut = null;
		CloseableHttpClient client = null;
		try {
			httpPut = new HttpPut(url);
