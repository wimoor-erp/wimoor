...
CREATE TABLE IF NOT EXISTS `t_amazon_group` (
  ...
  `financeprofitid` bigint unsigned DEFAULT NULL,
  `findex` int unsigned DEFAULT NULL,
  `isfinance` bit(1) DEFAULT NULL,
  `tax_number` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `custom_number` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `dxpid` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
