...
-- 导出  表 db_finance.fin_closing_template_item 结构
CREATE TABLE IF NOT EXISTS `fin_closing_template_item` (
  ...
  KEY `closing_template_id` (`closing_template_id`),
  KEY `closing_template_id_subject_id` (`closing_template_id`,`subject_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1973 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
