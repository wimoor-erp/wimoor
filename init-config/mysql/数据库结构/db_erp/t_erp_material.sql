...
CREATE TABLE IF NOT EXISTS `t_erp_material` (
  ...
  `groupid` bigint unsigned DEFAULT NULL COMMENT '所属店铺',
  ...
  `vatrate` float DEFAULT NULL COMMENT '增值税税率',
  `drawback_rate` decimal(20,6) DEFAULT NULL COMMENT '退税率',
  ...
  `other_cost` decimal(16,4) DEFAULT NULL,
  ...
  `is_ass_price` bit(1) DEFAULT NULL,
  `price_wavg` decimal(16,4) DEFAULT NULL,
  `price_ship_wavg` decimal(16,4) DEFAULT NULL,
  `addfee` decimal(16,4) DEFAULT NULL,
