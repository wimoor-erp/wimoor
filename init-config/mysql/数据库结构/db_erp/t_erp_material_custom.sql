...
-- 导出  表 db_erp.t_erp_material_custom 结构
CREATE TABLE IF NOT EXISTS `t_erp_material_custom` (
  ...
  `unit` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='海关表(国内出境），海关报关';
