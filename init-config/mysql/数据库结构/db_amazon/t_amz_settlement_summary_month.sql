...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_summary_month` (
  ...
  `transaction_type` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  ...
  `currency` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
