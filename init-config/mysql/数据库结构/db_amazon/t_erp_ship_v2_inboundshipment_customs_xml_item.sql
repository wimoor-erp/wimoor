...
-- 导出  表 db_amazon.t_erp_ship_v2_inboundshipment_customs_xml_item 结构
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_customs_xml_item` (
