...
-- 导出  表 db_amazon.t_erp_ship_v2_inboundshipment_custom 结构
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_custom` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='海关表-报关';
