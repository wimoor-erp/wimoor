...
CREATE TABLE IF NOT EXISTS `t_erp_material_consumable_safety_stock` (
  ...
  `opttime` datetime NOT NULL DEFAULT '2018-12-13 00:00:00',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_order_productitems` (
  ...
  `gmtCreate` datetime NOT NULL DEFAULT '2018-12-13 00:00:00',
  `gmtModified` datetime NOT NULL DEFAULT '2018-12-13 00:00:00',
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_address` (
  ...
  `opttime` datetime DEFAULT '2018-12-13 00:00:00' COMMENT '修改时间',
  `creator` bigint(20) unsigned DEFAULT '0' COMMENT '创建人',
  `creattime` datetime DEFAULT '2018-12-13 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
