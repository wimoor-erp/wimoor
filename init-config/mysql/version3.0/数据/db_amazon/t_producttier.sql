...
-- 正在导出表  db_amazon.t_producttier 的数据：~80 rows (大约)
...
INSERT INTO `t_producttier` (`id`, `name`, `isStandard`, `country`, `box_weight`, `amz_name`) VALUES
	...
	('light_large_oversize_us', '低价 Large Oversize', b'0', 'US', 0.0000, 'Lg-Oversize'),
	('light_large_standard_us', '低价 Large Standard-Size', b'1', 'US', 0.0000, 'Lg-Std'),
	('light_medium_oversize_us', '低价 Medium Oversize', b'0', 'US', 0.0000, 'Medium-Oversize'),
	('light_sml_oversize_us', '低价 Small Oversize', b'0', 'US', 0.0000, 'Sm-Oversize'),
	('light_sml_standard_us', '低价 Small Standard-Size', b'1', 'US', 0.0000, 'Sm-Std'),
	('light_special_oversize_us', '低价 Special Oversize', b'0', 'US', 0.0000, 'Special-Oversize'),
	...
	('std_ca', 'Standard', b'1', 'CA', 0.0000, NULL),
