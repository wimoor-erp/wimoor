...
CREATE TABLE IF NOT EXISTS `t_erp_assembly_form` (
  ...
  `ftype` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '组装=ass, 拆分=dis',
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `audittime` datetime DEFAULT NULL,
  `mainmid` bigint(20) unsigned DEFAULT NULL COMMENT '主sku id',
  `amount` int(11) DEFAULT NULL,
  `amount_handle` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_assembly_from_instock` (
  ...
  `optformid` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `formid` (`formid`),
...
CREATE TABLE IF NOT EXISTS `t_erp_customer` (
  ...
  `name` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '客户简称',
  `number` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '客户编码',
  `fullname` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '客户全称',
  `ftype` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '客户分类',
  `contacts` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '联系人',
  `phone_num` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '联系电话',
  `contact_info` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '其它联系信息',
  `address` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '地址',
  `shoplink` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品链接',
...
CREATE TABLE IF NOT EXISTS `t_erp_dispatch_form` (
  `id` bigint(20) unsigned NOT NULL,
  `number` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '调拨单号',
  `shopid` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_dispatch_oversea_form_entry` (
  ...
  `formid` bigint(20) unsigned DEFAULT NULL,
  `materialid` bigint(20) unsigned DEFAULT NULL,
  `sellersku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `formid` (`formid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_fin_account` (
  ...
  `name` char(50) COLLATE utf8mb4_bin DEFAULT '默认',
...
CREATE TABLE IF NOT EXISTS `t_erp_fin_journalaccount` (
  ...
  `ftype` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '记账类型:out,支出；in,收入',
  `projectid` bigint(20) unsigned DEFAULT NULL,
  `amount` decimal(18,4) DEFAULT NULL,
  `balance` decimal(18,4) DEFAULT NULL,
  `remark` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '操作人',
  `opttime` datetime DEFAULT NULL COMMENT '操作时间',
...
CREATE TABLE IF NOT EXISTS `t_erp_inventory` (
  ...
  `status` char(36) COLLATE utf8mb4_bin NOT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_inventory_record` (
  ...
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `materialid` bigint(20) unsigned DEFAULT NULL,
  `status` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `formtype` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `operate` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'in,out,readyin,readyout,cancel,stop',
  `number` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_inventory_record_form` (
  ...
  `warehouseid` bigint(20) unsigned NOT NULL,
  `materialid` bigint(20) unsigned NOT NULL,
  `startinbound` int(11) DEFAULT '0',
  `inbound` int(11) DEFAULT '0',
  `endinbound` int(11) DEFAULT '0',
  `startfulfillable` int(11) DEFAULT '0',
  `fulfillable` int(11) DEFAULT '0',
  `endfulfillable` int(11) DEFAULT '0',
  `startoutbound` int(11) DEFAULT '0',
  `outbound` int(11) DEFAULT '0',
  `endoutbound` int(11) DEFAULT '0',
  `formtype` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `operate` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material` (
  `id` bigint(20) unsigned NOT NULL COMMENT 'ID(h)',
  `sku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SKU',
  `name` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '名称',
  `shopid` bigint(20) unsigned DEFAULT NULL COMMENT '公司ID(h)',
  `upc` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '条码',
  `brand` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌',
  ...
  `specification` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '规格',
  ...
  `productCode` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '供应商产品代码',
  `delivery_cycle` int(11) DEFAULT NULL COMMENT '供货周期',
  `other_cost` decimal(10,2) DEFAULT NULL,
  `MOQ` int(10) unsigned DEFAULT '0' COMMENT '起订量：minimum order quantity',
  `purchaseUrl` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '采购链接',
  `remark` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `categoryid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类型id',
  `issfg` char(1) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '0:单独成品；1：组装成品；2：半成品',
  `color` char(10) COLLATE utf8mb4_bin DEFAULT '0',
  ...
  `createdate` datetime DEFAULT NULL,
  `creator` bigint(20) unsigned DEFAULT NULL,
  `parentid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用于导入数据是引用的系统内的那个SKU产品',
  ...
  KEY `shop_delete_sku_color` (`shopid`,`isDelete`,`mtype`,`sku`,`color`),
  KEY `supplier` (`supplier`),
  KEY `Index 4` (`shopid`,`owner`,`color`,`sku`,`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_material_brand` (
  ...
  `name` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1815552290684149762 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_material_group` (
  `materialid` bigint(20) unsigned NOT NULL,
  `groupid` char(36) COLLATE utf8mb4_bin NOT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material_his` (
  ...
  `brand` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌',
  `image` bigint(20) unsigned DEFAULT NULL COMMENT '图片',
  `itemDimensions` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品尺寸',
  `pkgDimensions` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '带包装尺寸',
  `boxDimensions` bigint(20) unsigned DEFAULT NULL,
  `boxnum` int(10) unsigned DEFAULT NULL,
  `specification` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '规格',
  `supplier` bigint(20) unsigned DEFAULT NULL COMMENT '供应商',
  ...
  `remark` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `categoryid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类型id',
  `issfg` char(10) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '0:单独成品；1：组装成品；2：半成品',
  `color` char(10) COLLATE utf8mb4_bin DEFAULT '0',
  `owner` bigint(20) unsigned DEFAULT '0',
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '操作人',
  ...
  `effectivedate` datetime DEFAULT NULL,
  `isSmlAndLight` bit(1) DEFAULT b'0' COMMENT '是否轻小产品',
  `assembly_time` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material_mark` (
  `materialid` bigint(20) unsigned NOT NULL,
  `ftype` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT 'notice：产品出现问题时发布的公告',
  `mark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material_supplier` (
  ...
  `purchaseUrl` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
  `productCode` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `specId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `offerid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_material_supplier_stepwise` (
  ...
  `materialid` bigint(20) unsigned NOT NULL,
  `supplierid` bigint(20) unsigned NOT NULL,
  `currency` char(5) COLLATE utf8mb4_bin DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `t_erp_outwh_form` (
  ...
  `customer` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `toaddress` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '发货地址',
  `express` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物流快递',
  `expressno` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '快递编号',
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `audittime` datetime DEFAULT NULL,
  `auditstatus` int(11) DEFAULT NULL,
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_auth` (
  ...
  `resource_owner` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `aliId` bigint(20) unsigned DEFAULT NULL,
  `memberId` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1816945911869497347 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_message` (
  ...
  `opttime` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10844 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_order_productitems` (
  ...
  `status` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0.000000',
  `statusStr` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0.000000',
  `skuInfos` varchar(500) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `productID` bigint(20) unsigned NOT NULL,
  `productCargoNumber` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  ...
  `unit` varchar(10) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `refundStatus` varchar(30) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_settlement` (
  ...
  `alibaba_account` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_settlement_order` (
  ...
  `paytype` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `returntype` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `returnamount` decimal(20,6) DEFAULT NULL,
  PRIMARY KEY (`orderid`),
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_settlement_order_return` (
  ...
  `returnamount` decimal(20,6) DEFAULT NULL,
  `returntype` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `returnto` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`orderid`),
  KEY `settlementid` (`settlementid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_settlement_pay` (
  ...
  `paytime` datetime DEFAULT NULL,
  `paymethod` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `paytype` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` decimal(20,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `settlementid` (`settlementid`)
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_alibaba_settlement_pay_return` (
  ...
  `settlementid` bigint(20) DEFAULT NULL,
  `returntime` datetime DEFAULT NULL,
  `returntype` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `number` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `settlementid` (`settlementid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='还款明细列表';
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form` (
  ...
  `batch` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `oldid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `number_shopid` (`shopid`,`number`),
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_entry_alibabainfo` (
  ...
  `signinfo` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`entryid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_entry_change` (
  ...
  `logistics` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` int(10) unsigned DEFAULT NULL,
  `auditstatus` int(10) unsigned DEFAULT '1' COMMENT '1:进行中，0：已完成',
  `totalin` int(10) unsigned DEFAULT NULL,
  `materialid` bigint(20) unsigned DEFAULT NULL,
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_entry_change_receive` (
  `id` bigint(20) unsigned NOT NULL,
  `entrychangeid` bigint(20) unsigned DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_entry_history` (
  ...
  `orderprice` decimal(10,2) DEFAULT NULL,
  `ischange` bit(1) DEFAULT b'0',
  `auditstatus` int(11) DEFAULT NULL COMMENT '0:草稿，退回；  1:待审核  ；2:审核通过 ；3：已完成,4.审核待下单',
  `paystatus` int(11) DEFAULT NULL,
  `planitemid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `inwhstatus` int(11) DEFAULT NULL,
  `totalpay` decimal(10,2) DEFAULT '0.00',
  `totalre` int(11) DEFAULT '0',
  `totalin` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_entry_logistics` (
  `entryid` bigint(20) unsigned NOT NULL,
  `logisticsId` char(25) COLLATE utf8mb4_bin NOT NULL,
  `refreshtime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_form_receive` (
  ...
  `formentryid` bigint(20) unsigned DEFAULT NULL,
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `ftype` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'in -入库，re -退货， ch-换货,clear-撤销入库',
  `amount` int(11) DEFAULT NULL,
  `remark` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_plansub` (
  ...
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `ftype` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'po代表订单，ao代表组装单',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_purchase_warahouse_status` (
  `warehouseid` bigint(20) unsigned NOT NULL,
  `purchase_status` int(11) DEFAULT '0' COMMENT '0表示改仓库无采购任务；1表示采购任务待处理；2表示采购任务已完成',
  `assbly_status` int(11) DEFAULT '0' COMMENT '0表示改仓库无组装任务；1表示组装任务待处理；2表示组装任务已完成',
...
-- 导出  表 db_erp.t_erp_ship_oversea_api 结构
CREATE TABLE IF NOT EXISTS `t_erp_ship_oversea_api` (
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transcompany` (
  `id` bigint(20) unsigned NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物流公司名称',
  `simplename` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `access_token` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `api` int(11) DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `uploadpath` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `isdelete` bit(1) DEFAULT b'0',
  `oldid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transdetail` (
  ...
  `company` bigint(20) unsigned DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `subarea` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `channel` bigint(20) unsigned DEFAULT NULL,
  `channame` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `pretime` int(11) DEFAULT NULL COMMENT 'US预计时效',
  `price` decimal(10,4) DEFAULT NULL,
  `drate` int(11) DEFAULT '5000',
  `opttime` datetime DEFAULT NULL,
  `transtype` bigint(20) unsigned DEFAULT NULL,
  `priceunits` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transdetail_his` (
  ...
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `subarea` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `channel` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `channame` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `pretime` int(11) DEFAULT NULL COMMENT 'US预计时效',
  `price` decimal(10,4) DEFAULT NULL,
  `drate` int(11) DEFAULT '5000',
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_transtype_day` (
  `transtypeid` bigint(20) unsigned NOT NULL,
  `shopid` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_stockcycle` (
  ...
  `min_cycle` int(11) DEFAULT NULL COMMENT '最小补货周期/最小发货周期',
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_unsalable` (
  `sku` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `invqty` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_calculate_record` (
  `id` bigint(20) unsigned NOT NULL,
  `shopid` bigint(20) unsigned NOT NULL,
  `ftype` char(20) COLLATE utf8mb4_bin NOT NULL COMMENT '计算类型，发货，采购，人力',
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_pickpay_form_entry` (
  ...
  `suggest` varchar(500) COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '建议提货量',
  `planpick` int(11) NOT NULL DEFAULT '0' COMMENT '建议付款金额',
  `planpay` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT '计划付款金额',
  `remark` varchar(500) COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '计划提货量',
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_presale_month_form_entry_item` (
  ...
  `amount` int(11) NOT NULL DEFAULT '0' COMMENT '对应计划数量',
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_presale_week` (
  ...
  `amount` int(11) NOT NULL DEFAULT '0' COMMENT '周预估销量',
  `opttime` datetime DEFAULT NULL COMMENT '修改时间',
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_purchase_material` (
  ...
  `shopid` bigint(20) unsigned NOT NULL COMMENT '公司ID',
  `materialid` bigint(20) unsigned NOT NULL COMMENT '本地产品ID',
  `purchasedaynum` int(11) DEFAULT NULL COMMENT '采购周期天数',
  `needamount` int(11) DEFAULT NULL COMMENT '需求量（通过采购周期内需求量汇总减去库存得出）',
  `suggestamount` int(11) DEFAULT NULL COMMENT '建议采购量（通过对需求量合箱规得出）',
  `sumrquest` int(11) DEFAULT NULL COMMENT '总需求量',
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_purchase_material_history` (
  ...
  `shopid` bigint(20) unsigned NOT NULL,
  `materialid` bigint(20) unsigned NOT NULL,
  `purchasedaynum` int(11) NOT NULL DEFAULT '0',
  `needamount` int(11) NOT NULL DEFAULT '0',
  `suggestamount` int(11) NOT NULL DEFAULT '0',
  `sumrquest` int(11) NOT NULL DEFAULT '0',
  `findex` int(11) DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_purchase_week` (
  ...
  `materialid` bigint(20) unsigned NOT NULL COMMENT '本地产品ID',
  `week` date NOT NULL COMMENT '周日期',
  `requestqty` int(11) NOT NULL DEFAULT '0' COMMENT '需求量（将商品销量通过对关系与本地产品对应）',
  `moreqty` int(11) DEFAULT '0' COMMENT '多余库存（库存减去对应安全库存+头程周期+增长天数对应需求量的和）',
  `suggestqty` int(11) DEFAULT '0' COMMENT '建议提货量（将需求量+剩余库存，缺少部分通过合箱规后）',
  `differentqty` int(11) DEFAULT '0' COMMENT '差异数量-（销售预测与库存之间的差异值）',
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_plan_purchase_week_history` (
  ...
  `materialid` bigint(20) unsigned NOT NULL,
  `week` date NOT NULL,
  `requestqty` int(11) NOT NULL DEFAULT '0',
  `moreqty` int(11) DEFAULT '0',
  `suggestqty` int(11) DEFAULT '0',
  `differentqty` int(11) DEFAULT '0',
  `isfull` bit(1) DEFAULT b'0',
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_productl_workhours` (
  ...
  `ftype` char(10) COLLATE utf8mb4_bin DEFAULT 'hour' COMMENT '类型: hour mins second等 默认hour',
  `creator` bigint(20) unsigned DEFAULT NULL,
  `createtime` datetime DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_v2_shop_units_worktime` (
  ...
  `unitsoftime` int(11) DEFAULT NULL COMMENT '每个人一个月的正常工作时间 h 工作时长（常规）	待增加	工作时长/人/月	增加参数设置（蔚蓝使用为204小时）	用作计算所需人力数量',
  `overoftime` int(11) DEFAULT NULL COMMENT '工作时长（较长）	待增加	工作时长/人/月	增加参数设置（蔚蓝使用为286小时）	用作计算所需人力数量',
  `opttime` datetime DEFAULT NULL COMMENT '操作时间',
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '操作人',
  PRIMARY KEY (`id`),
  UNIQUE KEY `shopid` (`shopid`)
...
CREATE TABLE IF NOT EXISTS `t_erp_v3_purchase_plan_item_history` (
  ...
  `planid` bigint(20) unsigned NOT NULL,
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `batchnumber` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse` (
  ...
  `ftype` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '类型',
  `flevel` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '级别',
  `number` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '编号',
  `address` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '地址',
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `findex` int(11) DEFAULT NULL COMMENT '次序',
  `country` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `groupid` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_shelf` (
  ...
  `name` varchar(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '货柜名称',
  `number` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '编码',
  ...
  `treepath` char(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '所有付货柜编码如：A01!033!F01',
  `shopid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '公司ID',
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_shelf_inventory` (
  ...
  `shopid` bigint(20) unsigned DEFAULT NULL COMMENT '公司ID',
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL COMMENT '当前数量',
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_type` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT 'ID',
  `shopid` bigint(20) unsigned DEFAULT NULL COMMENT '店铺',
  `issystem` bit(1) DEFAULT NULL COMMENT '是否系统',
  `name` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '名字',
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '操作人',
  `opttime` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `t_parameterconfig` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ptype` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `pkey` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
