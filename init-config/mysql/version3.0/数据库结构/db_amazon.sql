...
DELIMITER //
CREATE EVENT `opt_owner` ON SCHEDULE EVERY 1 DAY STARTS '2024-06-14 16:48:19' ON COMPLETION PRESERVE ENABLE DO BEGIN

update t_product_info  i
LEFT JOIN t_amazon_auth a ON a.id=i.amazonAuthId
LEFT JOIN t_product_in_opt o ON o.pid=i.id
LEFT JOIN t_erp_material m ON m.sku=IFNULL(o.msku,i.sku) AND m.shopid=a.shop_id AND m.isDelete=0
SET o.`owner`=m.`owner`
WHERE o.`owner` IS NULL AND m.`owner` IS NOT NULL ;
...
LEFT JOIN t_amazon_auth a ON a.id=i.amazonAuthId
LEFT JOIN t_product_in_opt o ON o.pid=i.id
LEFT JOIN t_erp_material m ON m.sku=i.sku AND m.shopid=a.shop_id AND m.isdelete=0
WHERE o.pid IS NULL
AND m.id IS NOT NULL
AND m.owner IS NOT NULL	;
...
CREATE TABLE IF NOT EXISTS `t_amazonseller_market` (
  `sellerid` char(30) COLLATE utf8mb4_bin NOT NULL COMMENT '卖家Sellerid',
  `marketplace_id` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT '站点ID',
  `country` char(2) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '国家编码',
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '站点英文名称',
  `language` char(5) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '对应语言编码',
  `currency` char(4) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '对应币种',
  `domain` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '对应域名',
...
CREATE TABLE IF NOT EXISTS `t_amazon_auth` (
  ...
  `sellerid` varchar(30) COLLATE utf8mb4_bin NOT NULL COMMENT '卖家ID',
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `region` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `MWSAuthToken` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '卖家授权码',
  ...
  `refresh_token` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `refresh_token_time` datetime DEFAULT NULL,
  `aws_region` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `createtime` datetime DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `oldid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `access_key_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `secret_key` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `role_arn` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `client_id` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `client_secret` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_api_timelimit` (
  `id` bigint(20) unsigned NOT NULL,
  `apiname` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_api_timelimit_seller_request` (
  ...
  `nexttoken` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_auth_api_timelimit` (
  ...
  `apiname` char(30) COLLATE utf8mb4_bin NOT NULL COMMENT 'API的名字',
  `nexttoken` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '是否有nexttoken',
  ...
  `log` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '异常log',
...
CREATE TABLE IF NOT EXISTS `t_amz_dimensions` (
  ...
  `length_units` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `width` decimal(15,2) DEFAULT NULL,
  `width_units` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `height` decimal(15,2) DEFAULT NULL,
  `height_units` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` decimal(15,2) DEFAULT NULL,
  `weight_units` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_amz_fbm_returns_report` (
  ...
  `order_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `sellerid` char(16) COLLATE utf8mb4_bin NOT NULL,
  `marketplaceid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazon_rma_id` char(36) COLLATE utf8mb4_bin NOT NULL,
  `merchant_rma_id` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `label_type` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `label_cost` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `carrier` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `trackingid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `labelpaidby` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `azclaim` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `isprime` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `inpolicy` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `returntype` char(36) COLLATE utf8mb4_bin NOT NULL,
  `resolution` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `invoice_number` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `return_delivery_date` datetime DEFAULT NULL,
  `order_amount` decimal(20,6) DEFAULT NULL,
  `order_quantity` int(11) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `amount` decimal(20,6) DEFAULT NULL,
  `asin` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `safet_action_reason` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `safet_claim_id` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `safet_claim_state` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `safet_claim_creation_time` datetime DEFAULT NULL,
  `safet_claim_reimbursement_amount` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `status` char(50) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_fin_account` (
  `amazonAuthid` bigint(20) unsigned NOT NULL,
  `groupid` char(50) COLLATE utf8mb4_bin NOT NULL,
  `currency` char(10) COLLATE utf8mb4_bin NOT NULL,
  ...
  `processing_status` char(40) COLLATE utf8mb4_bin NOT NULL,
  `trace_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `account_tail` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `fund_transfer_status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
  `nexttoken` varchar(1800) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_fin_settlement_formula` (
  `id` bigint(20) unsigned NOT NULL,
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `formula` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `field` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `creator` bigint(20) unsigned DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_fin_user_item_data` (
  ...
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'sku=* 号时，是指店铺费用',
...
CREATE TABLE IF NOT EXISTS `t_amz_follow_offer` (
  `sellerid` char(30) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_follow_offerchange` (
  `id` bigint(20) unsigned NOT NULL,
  `asin` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `availability_type` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `available_date` varchar(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `sub_condition` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `ships_from_state` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ships_from_country` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_inbound_fba_cycle` (
  ...
  `marketplaceid` char(15) COLLATE utf8mb4_bin NOT NULL,
  `name` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '名称',
  `number` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `stocking_cycle` int(11) DEFAULT '0' COMMENT '安全库存周期',
  `min_cycle` int(11) DEFAULT '0' COMMENT '发货频率',
  `put_on_days` int(11) DEFAULT '0' COMMENT '上架周期',
  `first_leg_days` int(11) DEFAULT '0' COMMENT '头程周期',
  `isdefault` bit(1) NOT NULL DEFAULT b'0',
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_amz_inventory_health` (
  ...
  `marketplaceid` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT '站点ID',
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL COMMENT 'SKU区分大小写',
  `authid` bigint(20) unsigned NOT NULL COMMENT '授权ID等价sellerid',
  `snapshot_date` datetime DEFAULT NULL COMMENT '报表更新时间',
  `fnsku` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '仓库SKUID',
  `asin` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'ASIN产品销售ID',
  `name` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '名称',
  `fcondition` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT '是否新旧',
  `sales_rank` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售排名',
  `product_group` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品分组',
  `total_quantity` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '当前总库存',
  `sellable_quantity` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '可销售数量',
  `unsellable_quantity` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '不可售数量',
  ...
  `units_shipped_last24hrs` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近24小时发货',
  `units_shipped_last7days` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近7天发货',
  `units_shipped_last30days` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近30天发货',
  `units_shipped_last90days` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近90天发货',
  `units_shipped_last180days` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近180天发货',
  `units_shipped_last365days` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最近365天发货',
  `weeks_of_cover_t7` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '7天周转',
  `weeks_of_cover_t30` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '30天周转',
  `weeks_of_cover_t90` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '90天周转',
  `weeks_of_cover_t180` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '180天周转',
  `weeks_of_cover_t365` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '360天周转',
  `num_afn_new_sellers` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '新产品的卖家数量',
  `num_afn_used_sellers` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '旧产品的卖家数量',
  `currency` char(100) COLLATE utf8mb4_bin NOT NULL COMMENT '币种',
  `your_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '你的售价',
  `sales_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '售价',
  `lowest_afn_new_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '新产品最低售价',
  `lowest_afn_used_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '旧产品最低售价',
  `lowest_mfn_new_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '新产品自发货最低售价',
  `lowest_mfn_used_price` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '旧产品自发货最低售价',
  `qty_to_be_charged_ltsf_12mo` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '超长期仓储费：超过365天的仓库费',
  `qty_in_long_term_storage_program` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '长期仓库数量',
  `qty_with_removals_in_progress` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '正在移除的数量',
  `projected_ltsf_12_mo` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '下期超长期仓储费',
  `per_unit_volume` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '库容',
  `is_hazmat` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '是否危险品',
  `in_bound_quantity` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '待入库数量',
  `asin_limit` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品限制',
  `inbound_recommend_quantity` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '建议待入库数量（即发货量）',
  `qty_to_be_charged_ltsf_6mo` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '长期仓储费',
  `projected_ltsf_6mo` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '下期长期仓储费',
  `opttime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_inventory_planning` (
  ...
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL COMMENT '平台产品SKU',
  `amazonauthid` bigint(20) unsigned NOT NULL COMMENT '授权ID',
  `countrycode` char(3) COLLATE utf8mb4_bin NOT NULL COMMENT '国家编码',
  `fnsku` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '仓库编码（产品条码）',
  `asin` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品编码',
  `condition` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT '商品状况',
  `available` int(11) DEFAULT NULL COMMENT '可用库存数量',
  `pending_removal_quantity` int(11) DEFAULT NULL COMMENT '等待移除的库存',
  `currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '币种',
  ...
  `alert` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '低流量或低转化率提醒',
  ...
  `recommended_action` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '建议您对库存执行的操作。建议的依据是您当前的买家需求以及采取措施是否比不采取任何措施花费更低',
  ...
  `volume_unit_measurement` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品体积的计量单位',
  `storage_type` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '仓储类型分类：有六种仓储类型：标准尺寸、大件、服装、鞋靴、易燃物或气溶胶',
  `storage_volume` decimal(20,6) DEFAULT NULL COMMENT '存储体积',
  `product_group` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品分类',
  ...
  `fba_minimum_inventory_level` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最低水位库存量',
  `historical_days_of_supply` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '历史供货天数',
  `fba_inventory_level_health_status` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '库存健康状态',
...
CREATE TABLE IF NOT EXISTS `t_amz_merchant_shipping_group` (
  `id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `amazonauthid` bigint(20) unsigned NOT NULL DEFAULT '0',
  `marketplaceid` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_amz_notifications` (
  ...
  `notifications` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_notifications_destination` (
  `destinationid` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '接受消息对象的ID',
  `name` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '接受消息对象的名称',
  `resource_sqs_arn` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '消息队列arn',
  `resource_event_bridge_region` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '本地bridge区域',
  `resource_event_bridge_accountid` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '本地bridge账号',
  `resource_event_bridge_name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
  `awsregion` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_notifications_subscriptions` (
  `subscriptionId` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '订阅ID',
  `amazonauthid` bigint(20) unsigned NOT NULL COMMENT '授权ID',
  `eventFilterType` char(50) COLLATE utf8mb4_bin NOT NULL COMMENT '订阅类型',
  `payloadVersion` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '版本',
  `destinationId` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '接受信息的目标',
  `aggregationSettings` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '聚合时间',
  `marketplaceIds` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '站点',
...
CREATE TABLE IF NOT EXISTS `t_amz_orders_address` (
  `amazon_order_id` char(20) COLLATE utf8mb4_bin NOT NULL,
  ...
  `address_line3` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `address_type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `city` char(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `country_code` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `county` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `district` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `municipality` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `postal_code` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `state_or_region` char(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_order_buyer_ship_address` (
  `id` bigint(20) unsigned NOT NULL,
  `amazon_order_id` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplaceId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonAuthId` bigint(20) unsigned DEFAULT NULL,
  `name` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `address1` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `address2` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `address3` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `city` varchar(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `county` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '区县',
  `district` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `state` varchar(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `postalcode` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `countrycode` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `phone` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_order_item` (
  `id` bigint(20) unsigned NOT NULL,
  `amazon_order_id` varchar(30) COLLATE utf8mb4_bin NOT NULL,
  `purchase_date` datetime NOT NULL,
  `last_updated_date` datetime DEFAULT NULL,
  `orderItemId` varchar(30) COLLATE utf8mb4_bin NOT NULL,
  ...
  `promotion_ids` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `CODFee` decimal(10,2) DEFAULT NULL,
  `CODFeeDiscount` decimal(10,2) DEFAULT NULL,
  `GiftMessageText` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `GiftWrapLevel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `ConditionId` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ConditionSubtypeId` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ConditionNote` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_order_main` (
  `id` bigint(20) unsigned NOT NULL,
  `amazon_order_id` varchar(20) COLLATE utf8mb4_bin NOT NULL,
  `seller_order_id` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `replaced_orderid` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `purchase_date` datetime NOT NULL,
  `last_updated_date` datetime DEFAULT NULL,
  `order_status` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillment_channel` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `sales_channel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `order_channel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_service_level` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '货件服务水平',
  ...
  `numberOfItemsShipped` int(11) DEFAULT NULL COMMENT '已配送的商品数量。',
  `numberOfItemsUnshipped` int(11) DEFAULT NULL COMMENT '未配送的商品数量。',
  `paymentMethod` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'COD 订单的次级付款方式',
  `payment_execution_detail_item` decimal(10,0) DEFAULT NULL COMMENT '使用同级PaymentMethod响应元素指明的次级付款方式支付的金额',
  `buyer_email` varchar(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `buyer_name` tinyblob,
  `shipment_serviceLevel_category` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单的配送服务级别分类。',
  `fulfillment_supply_sourceid` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `CbaDisplayableShippingLabel` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '卖家自定义的配送方式，属于Checkout by Amazon (CBA) 所支持的四种标准配送设置中的一种',
  `orderType` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_pdt_price_opt` (
  ...
  `businesstype` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `businesslist` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_po_rpt_day` (
  ...
  `sales_channel` char(25) COLLATE utf8mb4_bin NOT NULL,
  `sku` char(40) COLLATE utf8mb4_bin NOT NULL,
  `order_status` char(10) COLLATE utf8mb4_bin NOT NULL,
  `asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `quantity` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_active` (
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT '站点',
  `sku` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '用户码sku',
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '唯一码asin',
...
CREATE TABLE IF NOT EXISTS `t_amz_product_active_daynum` (
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  `marketplaceid` char(14) COLLATE utf8mb4_bin NOT NULL,
  `byday` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_pageviews` (
  ...
  `SKU` char(50) COLLATE utf8mb4_bin NOT NULL,
  `byday` date NOT NULL,
  `child_asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `parent_asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_pageviews_download` (
  ...
  `SKU` char(50) COLLATE utf8mb4_bin NOT NULL,
  `byday` date NOT NULL,
  `parent_asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `child_asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `Sessions` int(11) DEFAULT NULL COMMENT '访问量（点击量）',
  `Session_Percentage` decimal(10,2) DEFAULT NULL COMMENT '访问比例',
  `Page_Views` int(11) DEFAULT NULL COMMENT '浏览量',
  `Page_Views_Percentage` decimal(10,2) DEFAULT NULL,
  `Buy_Box_Percentage` decimal(10,2) DEFAULT NULL,
  `Units_Ordered` int(11) DEFAULT NULL COMMENT '销量',
  `Units_Ordered_B2B` int(11) DEFAULT NULL,
  `Unit_Session_Percentage` decimal(10,2) DEFAULT NULL,
  `Unit_Session_Percentage_B2B` decimal(10,2) DEFAULT NULL,
  `Ordered_Product_Sales` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_pageviews_month` (
  `amazonAuthid` bigint(20) unsigned NOT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin NOT NULL,
  `SKU` char(36) COLLATE utf8mb4_bin NOT NULL,
  `byday` date NOT NULL,
  `parent_asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `child_asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `Sessions` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_price_record` (
  ...
  `ftype` tinyint(4) DEFAULT '0' COMMENT '1:永久调价，2，临时调价，3，商务调价',
  `remark` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_sales_plan` (
  ...
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `amazonauthid` bigint(20) unsigned DEFAULT NULL,
  `shipday` int(11) DEFAULT NULL,
  `delivery_cycle` int(11) DEFAULT NULL,
  `avgsales` int(11) DEFAULT NULL,
  `needship` int(11) DEFAULT NULL,
  `needshipfba` int(11) DEFAULT NULL,
  `needpurchase` int(11) DEFAULT NULL,
  `ship_min_cycle_sale` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_product_sales_plan_ship_item` (
  ...
  `batchnumber` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_report_request_type` (
  ...
  `cname` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '中文名称',
  `ename` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '英文名称',
  `code` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '报表编码',
  `description` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '描述',
  `bean` varchar(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '报表处理类',
  `day` int(11) NOT NULL DEFAULT '0' COMMENT '报表默认请求天数',
  `disabled` bit(1) DEFAULT b'0' COMMENT '是否可用',
  `reportOptions` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '报表默认参数',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_returns_report` (
  ...
  `marketplaceid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `fulfillment_center_id` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `detailed_disposition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `license_plate_number` char(30) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `customer_comments` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_inventory_age` (
  ...
  `marketplace` char(20) COLLATE utf8mb4_bin NOT NULL,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `fcondition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `qty_with_removals_in_progress` int(11) DEFAULT NULL,
  ...
  `inv_age_271_to_365_days` int(11) DEFAULT NULL,
  `inv_age_365_plus_days` int(11) DEFAULT NULL,
  `currency` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `qty_to_be_charged_ltsf_6_mo` int(11) DEFAULT NULL,
  `projected_ltsf_6_mo` decimal(20,6) DEFAULT NULL,
  `qty_to_be_charged_ltsf_12_mo` int(11) DEFAULT NULL,
  `projected_ltsf_12_mo` decimal(20,6) DEFAULT NULL,
  `units_shipped_last_7_days` int(11) DEFAULT NULL,
  `units_shipped_last_30_days` int(11) DEFAULT NULL,
  `units_shipped_last_60_days` int(11) DEFAULT NULL,
  `units_shipped_last_90_days` int(11) DEFAULT NULL,
  ...
  `recommended_action` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `volume_units` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `storage_type` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_inventory_country` (
  ...
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SKU',
  `fnsku` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'FBA仓库标示码',
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品标示',
  `fcondition` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品新旧类型',
  `country` char(5) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '国家',
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_inventory_detail` (
  ...
  `fnsku` char(11) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(11) COLLATE utf8mb4_bin DEFAULT NULL,
  `msku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `country` char(6) COLLATE utf8mb4_bin DEFAULT NULL,
  `eventType` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `referenceID` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillmentCenter` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `disposition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `reconciledQuantity` int(11) DEFAULT NULL,
  `unreconciledQuantity` int(11) DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_inventory_summary` (
  ...
  `authid` bigint(20) unsigned DEFAULT NULL,
  `byday` date DEFAULT NULL,
  `location` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `msku` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `disposition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `startingWarehouseBalance` int(11) DEFAULT NULL,
  `endingWarehouseBalance` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_orders_fulfilled_shipments_fee` (
  ...
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazon_order_id` char(20) COLLATE utf8mb4_bin NOT NULL,
  `shipmentid` char(20) COLLATE utf8mb4_bin NOT NULL,
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL,
  `itemid` char(20) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_rpt_orders_fulfilled_shipments_report` (
  ...
  `shipment_item_id` char(20) COLLATE utf8mb4_bin NOT NULL,
  `amazon_order_item_id` char(15) COLLATE utf8mb4_bin NOT NULL,
  `merchant_order_item_id` char(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `purchase_date` datetime DEFAULT NULL,
  `payments_date` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_scout_asins` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sour_date` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '抓取的日期',
  `marketplace` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '格式: Amazon.com / Amazon.co.uk 等',
  `currency` varchar(6) COLLATE utf8mb4_bin NOT NULL COMMENT '格式: USD / GBP ..',
  `type` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '榜单类型',
  `category_top` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '一级榜单品类',
  `category` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '当前的榜单品类(抓取时)',
  ...
  `product_url` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `image_url` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  `product_title` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `prime_icon` char(5) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '是否是PRIME,空为否',
  `rank_date` date DEFAULT NULL COMMENT '计算的日期.以下字段需要计算补充',
  `product_rank` int(11) DEFAULT NULL,
  `Length` double DEFAULT NULL,
  `Width` double DEFAULT NULL,
  `Height` double DEFAULT NULL,
  `LWH_unit` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '长宽高的单位',
  `Weight` double DEFAULT NULL,
  `Weight_unit` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '重量单位',
  `fba_fee` double DEFAULT NULL,
  `est_profit` double DEFAULT NULL COMMENT '利润. 使用的利润方案统一为: TUPARKA-pan_EU . 采购成本计为0. ',
  `costdetail` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_acc_report` (
  ...
  `amazonauthid` bigint(20) unsigned NOT NULL,
  `marketplace_name` char(40) COLLATE utf8mb4_bin NOT NULL,
  `settlement_start_date` datetime DEFAULT NULL,
  `settlement_end_date` datetime DEFAULT NULL,
  `deposit_date` datetime DEFAULT NULL,
  `total_amount` decimal(15,2) DEFAULT NULL,
  `currency` char(7) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_acc_statement` (
  ...
  `shopid` bigint(20) unsigned NOT NULL,
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `marketplaceid` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `startdate` date DEFAULT NULL,
  `enddate` date DEFAULT NULL,
  `datetype` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `summaryall` mediumblob,
  `listdata` longblob,
  `fielddata` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `key` (`shopid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_amount_description` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `cname` varchar(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `ename` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `cdescription` varchar(1000) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `edescription` varchar(1000) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_amount_type_nonsku` (
  `transaction_type` char(40) COLLATE utf8mb4_bin NOT NULL,
  `amount_type` char(40) COLLATE utf8mb4_bin NOT NULL,
  `amount_description` char(100) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_open` (
  ...
  `settlement_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `posted_date` datetime NOT NULL,
  `amazon_order_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `order_item_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplace_name` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `account_type` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillment` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `event_type` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `ftype` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` decimal(20,6) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_report` (
  ...
  `settlement_id` bigint(20) unsigned NOT NULL,
  `currency` char(7) COLLATE utf8mb4_bin DEFAULT NULL,
  `transaction_type` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `order_id` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `merchant_order_id` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `adjustment_id` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `shipment_id` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplace_name` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount_type` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount_description` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount` decimal(15,2) DEFAULT NULL,
  `fulfillment_id` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `posted_date` date NOT NULL,
  `posted_date_time` datetime DEFAULT NULL,
  `order_item_code` char(16) COLLATE utf8mb4_bin DEFAULT NULL,
  `merchant_order_item_id` char(150) COLLATE utf8mb4_bin DEFAULT NULL,
  `merchant_adjustment_item_id` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity_purchased` int(11) DEFAULT NULL,
  `promotion_id` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`amazonAuthId`,`posted_date`,`id`),
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_summary_day` (
  ...
  `marketplace_name` char(40) COLLATE utf8mb4_bin NOT NULL,
  `posted_date` date NOT NULL,
  `transaction_type` char(40) COLLATE utf8mb4_bin NOT NULL COMMENT '商品费用',
  `amount_type` char(40) COLLATE utf8mb4_bin NOT NULL,
  `amount_description` char(100) COLLATE utf8mb4_bin NOT NULL,
  `fulfillment_type` char(5) COLLATE utf8mb4_bin NOT NULL,
  `currency` char(7) COLLATE utf8mb4_bin NOT NULL,
  `amount` decimal(15,2) DEFAULT NULL,
  `quantity_purchased` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_settlement_summary_sku_month` (
  ...
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  `sku` char(40) COLLATE utf8mb4_bin NOT NULL,
  `msku` char(40) COLLATE utf8mb4_bin NOT NULL,
  `groupid` bigint(20) unsigned NOT NULL,
  `asin` char(15) COLLATE utf8mb4_bin NOT NULL,
  `parentasin` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `categoryid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplace_name` char(40) COLLATE utf8mb4_bin NOT NULL,
  `posted_date` date NOT NULL,
  `owner` bigint(20) unsigned DEFAULT NULL,
  `pid` bigint(20) unsigned DEFAULT NULL,
  ...
  `rpt_disposal_units` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_ship_fulfillment_anysis_center` (
  ...
  `address_name` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_submitfeed` (
  ...
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `feed_type` char(50) COLLATE utf8mb4_bin NOT NULL,
  `submitted_date` datetime DEFAULT NULL,
  `started_processing_date` datetime DEFAULT NULL,
  `completed_processiong_date` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `feed_processing_status` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `queueid` bigint(20) unsigned DEFAULT NULL,
  `amzprocesslog` blob,
  `documentid` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_amz_submitfeed_queue` (
  ...
  `amazonAuthId` bigint(20) unsigned DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `feed_type` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `process_date` timestamp NULL DEFAULT NULL,
  `filename` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `content` blob,
  `process_log` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `submitfeedid` bigint(20) unsigned DEFAULT NULL,
  `createtime` timestamp NULL DEFAULT NULL,
  `feedoptions` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_authority` (
  ...
  `menuid` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `url` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '定义Action',
  `name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '权限名称',
...
CREATE TABLE IF NOT EXISTS `t_daysales_formula` (
  ...
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `formula` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `formula_name` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_estimated_sales` (
  ...
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `presales` int(11) DEFAULT NULL COMMENT '手动输入日均销量',
...
CREATE TABLE IF NOT EXISTS `t_erp_market_priority` (
  `marketplaceid` varchar(36) COLLATE utf8mb4_bin NOT NULL,
  `groupid` bigint(20) unsigned NOT NULL,
  `priority` int(11) DEFAULT NULL COMMENT 'FBA站点优先级',
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_shipcycle` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `sku` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `transtype` bigint(20) unsigned DEFAULT NULL,
  `stockingCycle` int(11) DEFAULT NULL COMMENT '安全库存周期',
  `min_cycle` int(11) DEFAULT NULL COMMENT '最小发货周期',
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_address` (
  ...
  `city` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '城市',
  `districtOrCounty` char(25) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '区或县 ',
  `stateOrProvinceCode` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '省份代码',
  ...
  `phone` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `email` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `contact` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `companyName` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_addressto` (
  ...
  `districtOrCounty` char(25) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '区或县 ',
  `stateOrProvinceCode` char(40) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '省份代码',
  `countryCode` char(2) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '国家/地区代码',
  `postalCode` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '邮政编码',
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `phone` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_config_carrier` (
  `country` char(10) COLLATE utf8mb4_bin NOT NULL,
  `name` char(30) COLLATE utf8mb4_bin NOT NULL,
  `transtyle` char(5) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundbox` (
  `id` bigint(20) unsigned NOT NULL,
  `shipmentid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `tracking_id` char(32) COLLATE utf8mb4_bin DEFAULT NULL,
  `package_status` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundcase` (
  `id` bigint(20) unsigned NOT NULL,
  `shipmentid` char(36) COLLATE utf8mb4_bin NOT NULL,
  `merchantsku` char(50) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inbounditem` (
  ...
  `FulfillmentNetworkSKU` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `SellerSKU` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品的卖家 SKU。',
  `QuantityShipped` int(11) DEFAULT NULL,
  `QuantityReceived` int(11) DEFAULT NULL,
  `QuantityInCase` int(11) DEFAULT NULL,
  `Quantity` int(11) DEFAULT NULL COMMENT '	要配送的商品数量。',
  `PrepInstruction` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `PrepOwner` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundplan` (
  ...
  `labelPrepType` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '	入库货件所需的标签准备类型。',
  ...
  `invtype` tinyint(4) DEFAULT '0',
  `plansubid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `creator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundshipment` (
  `ShipmentId` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT '货件编号',
  `DestinationFulfillmentCenterId` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '	亚马逊创建的亚马逊配送中心标识。',
  `ShipToAddressID` bigint(20) unsigned DEFAULT NULL COMMENT '目的地',
  `LabelPrepType` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `ShipmentStatus` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'ShipmentStatus 值：WORKING - 卖家已创建货件，但未发货。 SHIPPED - 承运人已取件。',
  `inboundplanid` bigint(20) unsigned DEFAULT NULL COMMENT 'planId',
  `name` char(80) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'shipment_name',
  `TotalUnits` int(11) DEFAULT NULL COMMENT '装运单位数',
  `FeePerUnit` decimal(10,2) DEFAULT NULL COMMENT '单位手工加工费',
  `status` int(11) DEFAULT NULL COMMENT '-1,已驳回；0取消货件；1,待审核；2，配货（已确认货件）；3，装箱；4，物流信息确认；5已发货；6，已完成发货',
  ...
  `currency` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '货币',
  `carrier` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '承运人',
  `boxnum` int(11) DEFAULT NULL,
  `oldboxnum` int(11) DEFAULT NULL,
  `transtyle` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  ...
  `feedstatus` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `pro_number` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `referenceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `transport_status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `box_contents_source` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `sync_inv` tinyint(4) DEFAULT '0' COMMENT '1代表没有扣库存，2代表已经扣库存',
  `check_inv` bigint(20) unsigned DEFAULT NULL COMMENT '下架ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=763095 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundshipment_traceupload` (
  ...
  `shopid` bigint(20) unsigned NOT NULL,
  `status` tinyint(4) DEFAULT NULL COMMENT '0待处理，1,已处理，2，处理失败',
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_inboundtrans` (
  ...
  `ordernum` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_status` (
  `status` char(20) COLLATE utf8mb4_bin NOT NULL,
  `content` char(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `name` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_destination_address` (
  `code` char(13) COLLATE utf8mb4_bin NOT NULL,
  `destinationType` char(30) COLLATE utf8mb4_bin NOT NULL,
  `name` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '名称或公司名称。',
  `addressLine1` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '街道地址信息。',
  `addressLine2` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '其他街道地址信息（如果需要）。',
  `city` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '城市',
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundbox` (
  ...
  `packing_group_id` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `shipmentid` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `boxnum` int(10) DEFAULT NULL,
  `length` decimal(15,2) DEFAULT NULL,
  `width` decimal(15,2) DEFAULT NULL,
  `height` decimal(15,2) DEFAULT NULL,
  `unit` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inbounditem` (
  ...
  `label_owner` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `manufacturing_lot_code` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `prep_owner` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `msku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(10) DEFAULT NULL,
  `confirm_quantity` int(10) DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundoperation` (
  `operationid` char(40) COLLATE utf8mb4_bin NOT NULL,
  `formid` bigint(20) unsigned NOT NULL,
  `operation_status` char(12) COLLATE utf8mb4_bin DEFAULT NULL,
  `operation` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL,
  `operation_problem` varchar(8000) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundplan` (
  `id` bigint(20) unsigned NOT NULL,
  `inbound_pland_id` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `name` char(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `number` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `placement_option_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `source_address` bigint(20) unsigned DEFAULT NULL COMMENT '	您的退货地址。(发货地址)',
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `amazonauthid` bigint(20) unsigned DEFAULT NULL,
  `marketplaceid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `warehouseid` bigint(20) unsigned DEFAULT NULL,
  `auditor` bigint(20) unsigned DEFAULT NULL,
  `auditstatus` tinyint(3) DEFAULT NULL COMMENT '1 已提交（待审核）； 2待配货 3,待装箱；4待发货；  7已发货； 11已驳回； 12已取消',
  `invstatus` tinyint(3) DEFAULT NULL COMMENT '0 未扣库存；1锁定待出库库存；2 已经出库',
  `auditime` datetime DEFAULT NULL,
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `pre_shipping_date` date DEFAULT NULL COMMENT '预计出库时间',
  `shipping_date` date DEFAULT NULL,
  `shipping_solution` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SEND 亚马逊合作承运商:AMAZON_PARTNERED_CARRIER; 非合作承运商:USE_YOUR_OWN_CARRIER',
  `transtyle` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SP:小包裹快递(SPD),LTL:托盘配送,NONE',
  `transtype` bigint(20) unsigned DEFAULT NULL COMMENT '运输方式',
  `invtype` tinyint(3) DEFAULT '0' COMMENT '0:代表正常库存流程，1：代表不扣库存，2代表同步过来的计划直接扣可用库存',
  `batchnumber` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `check_inv` bigint(20) unsigned DEFAULT NULL,
  ...
  KEY `Index 3` (`createtime`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundplan_packing_options` (
  `packing_option_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `inbound_plan_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `formid` bigint(20) unsigned DEFAULT NULL,
  `status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `contents` text COLLATE utf8mb4_bin,
  `opttime` datetime DEFAULT NULL,
  `operator` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundplan_packing_options_group_item` (
  `packing_group_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `inbound_plan_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL,
  `formid` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundplan_placement_options` (
  `placement_option_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `inbound_plan_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `formid` bigint(20) unsigned DEFAULT NULL,
  `status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `contents` text COLLATE utf8mb4_bin,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment` (
  `shipmentid` char(50) COLLATE utf8mb4_bin NOT NULL COMMENT '货件编号',
  `referenceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `destination` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '	亚马逊创建的亚马逊配送中心标识。',
  `shipment_confirmation_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `placement_option_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `transportation_option_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `delivery_window_option_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `addressid` bigint(20) unsigned DEFAULT NULL,
  `shipmentstatus` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'ShipmentStatus 值：WORKING - 卖家已创建货件，但未发货。 SHIPPED - 承运人已取件。',
  `formid` bigint(20) unsigned DEFAULT NULL COMMENT 'planId',
  `totalunits` int(10) unsigned DEFAULT NULL COMMENT '装运单位数',
  `feeunit` decimal(20,6) unsigned DEFAULT NULL COMMENT '单位手工加工费',
  `totalfee` decimal(20,6) unsigned DEFAULT NULL COMMENT '装运的总手工加工费',
  `currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `inboundplanid` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `name` char(80) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'shipment_name',
  `status` int(10) DEFAULT NULL COMMENT '-1,已驳回；0取消货件；1,待审核；2，配货（已确认货件）；3，装箱；4，物流信息确认；5已发货；6，已完成发货',
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `carrier` char(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '承运人',
  `transtyle` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `transtype` bigint(20) unsigned DEFAULT NULL COMMENT '运输方式',
  ...
  `pro_number` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `transport_status` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `sync_inv` tinyint(3) DEFAULT '0' COMMENT '1代表没有扣库存，2代表已经扣库存',
  `check_inv` bigint(20) unsigned DEFAULT NULL,
  `ignorerec` bit(1) DEFAULT b'0' COMMENT '忽略收货异常',
  ...
  KEY `idx_inboundplanid_status_refreshtime` (`formid`,`status`,`refreshtime`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_box` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `formid` bigint(20) unsigned DEFAULT NULL,
  `packing_group_id` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `shipmentid` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `placement_option_id` char(38) COLLATE utf8mb4_bin DEFAULT NULL,
  `boxnum` int(10) DEFAULT NULL,
  `length` decimal(15,2) DEFAULT NULL,
  `width` decimal(15,2) DEFAULT NULL,
  `height` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_boxitem` (
  `id` bigint(20) unsigned NOT NULL,
  `boxid` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `expiration` datetime DEFAULT NULL,
  `label_owner` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `manufacturing_lot_code` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `prep_owner` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_customs` (
  ...
  `code` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '海关编码',
  `rate` decimal(20,6) DEFAULT NULL,
  `material` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品材质',
  `application` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用途',
  `url` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `ename` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品英文名',
  `cname` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品中文名',
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  `creator` bigint(20) unsigned DEFAULT NULL,
  `createtime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_delivery` (
  `delivery_window_option_id` char(50) COLLATE utf8mb4_bin NOT NULL,
  `availability_type` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `editable_until` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `end_date` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `start_date` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_item` (
  ...
  `shipmentid` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `PrepInstruction` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `expiration` datetime DEFAULT NULL,
  `fnsku` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `label_owner` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `manufacturing_lot_code` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `prep_owner` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `msku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(10) DEFAULT NULL,
  ...
  `totalcost` decimal(20,6) DEFAULT NULL,
  `unitcost` decimal(20,6) DEFAULT NULL,
  `prepinstructions` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `shipmentid` (`shipmentid`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inbound_record` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `formid` bigint(20) unsigned NOT NULL,
  `shipmentid` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '#',
  `status` int(10) NOT NULL COMMENT '-1,已驳回；0取消货件；1,待审核；2，配货（已确认货件）；3，装箱；4，物流信息确认；5已发货；6，已完成发货',
  `opttime` datetime DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_erp_summary_data` (
  `id` bigint(20) unsigned NOT NULL,
  `ftype` char(20) COLLATE utf8mb4_bin NOT NULL,
  `value` decimal(10,2) DEFAULT NULL,
  `mapdata` varchar(4000) COLLATE utf8mb4_bin DEFAULT NULL,
  `shopid` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_erp_warehouse_fba` (
  ...
  `number` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `stocking_cycle` int(11) DEFAULT '0' COMMENT '安全库存周期',
  `min_cycle` int(11) DEFAULT '0' COMMENT '最小发货周期',
  `put_on_days` int(11) DEFAULT '0' COMMENT '上架周期',
  `first_leg_days` int(11) DEFAULT '0' COMMENT '头程周期',
  `remark` varchar(1000) COLLATE utf8mb4_bin DEFAULT '0',
  `operator` bigint(20) unsigned DEFAULT NULL COMMENT '操作人',
...
) ENGINE=InnoDB AUTO_INCREMENT=476645 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='汇率';
...
CREATE TABLE IF NOT EXISTS `t_fbaformat` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL,
  `country` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ismedia` bit(1) DEFAULT NULL,
  `producttierId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `fba_format` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `month` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` decimal(10,4) DEFAULT NULL COMMENT '最大重量',
  `effective_date` date DEFAULT NULL COMMENT '生效日期',
  `expiry_date` date DEFAULT NULL COMMENT '失效日期',
  `dispatch_type` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '亚马逊配送方案',
...
CREATE TABLE IF NOT EXISTS `t_fba_estimated_fees` (
  ...
  `asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `product_name` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `product_group` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `brand` char(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfilled_by` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `has_local_inventory` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `unit_of_dimension` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `item_package_weight` decimal(10,2) DEFAULT NULL,
  `unit_of_weight` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `product_size_tier` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_fba_fbasipp` (
  ...
  `format` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_fba_labeling_service_fee` (
  ...
  `country` char(12) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `country` (`country`),
...
CREATE TABLE IF NOT EXISTS `t_fba_longterm_storage_fee_report` (
  ...
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `condition` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(255) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `surcharge_age_tier` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_fba_reimbursements_fee_report` (
  ...
  `reimbursement_id` char(20) COLLATE utf8mb4_bin NOT NULL,
  `case_id` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazon_order_id` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '原因',
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `conditions` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `currency_unit` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `amount_per_unit` decimal(16,4) DEFAULT NULL,
  `amount_total` decimal(16,4) DEFAULT NULL,
  `quantity_reimbursed_cash` int(11) DEFAULT NULL,
  `quantity_reimbursed_inventory` int(11) DEFAULT NULL,
  `quantity_reimbursed_total` int(11) DEFAULT NULL,
  `original_reimbursement_id` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `original_reimbursement_type` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonauthid` bigint(20) unsigned NOT NULL,
  `lastupdate` datetime DEFAULT NULL,
  PRIMARY KEY (`amazonauthid`,`approval_date`,`id`),
  KEY `marketplaceid` (`marketplaceid`),
  KEY `reimbursement_id_amazon_order_id_sku` (`sku`,`amazon_order_id`,`reimbursement_id`,`reason`),
...
CREATE TABLE IF NOT EXISTS `t_fba_storage_fee_report` (
  `id` bigint(20) unsigned NOT NULL,
  `asin` char(20) COLLATE utf8mb4_bin NOT NULL,
  `fnsku` char(20) COLLATE utf8mb4_bin NOT NULL,
  `fulfillment_center` char(15) COLLATE utf8mb4_bin NOT NULL,
  `country` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT 'country_code',
  `longest_side` decimal(10,2) DEFAULT NULL,
  `median_side` decimal(10,2) DEFAULT NULL,
  `shortest_side` decimal(10,2) DEFAULT NULL,
  `measurement_units` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` decimal(10,2) DEFAULT NULL,
  `weight_units` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `item_volume` decimal(12,4) DEFAULT NULL,
  `volume_units` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `product_size_tier` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `month` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT '收费的月份，如2019-11 month_of_charge',
  `storage_utilization_ratio` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `storage_utilization_ratio_units` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `dangerous_goods_storage_type` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `eligible_for_inventory_discount` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `qualifies_for_inventory_discount` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `total_incentive_fee_amount` decimal(20,6) DEFAULT NULL,
  `breakdown_incentive_fee_amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_fba_storage_fee_report_archive` (
  ...
  `asin` char(20) COLLATE utf8mb4_bin NOT NULL,
  `fnsku` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillment_center` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `country` char(10) COLLATE utf8mb4_bin NOT NULL,
  `longest_side` decimal(10,2) DEFAULT NULL,
  `median_side` decimal(10,2) DEFAULT NULL,
  `shortest_side` decimal(10,2) DEFAULT NULL,
  `unit_of_dimension` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` decimal(10,2) DEFAULT NULL,
  `unit_of_weight` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `item_volume` decimal(12,4) DEFAULT NULL,
  `volume_units` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `product_size_tier` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `month` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '收费的月份，如2019-11',
  `storage_rate` decimal(10,2) DEFAULT NULL,
  `currency` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `month` (`month`),
  KEY `index1` (`amazonauthid`,`country`,`asin`,`month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;

-- 数据导出被取消选择。

-- 导出  表 db_amazon.t_fba_storage_fee_report_bkpold20240725 结构
CREATE TABLE IF NOT EXISTS `t_fba_storage_fee_report_bkpold20240725` (
  `id` bigint(20) unsigned NOT NULL,
  `asin` char(20) COLLATE utf8mb4_bin NOT NULL,
  `fnsku` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillment_center` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `amazonauthid` bigint(20) unsigned NOT NULL,
  `lastupdate` datetime DEFAULT NULL,
  PRIMARY KEY (`month`,`amazonauthid`,`country`,`id`),
  KEY `index1` (`amazonauthid`,`country`,`asin`,`month`,`fulfillment_center`,`fnsku`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_fixed_closingfee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `format` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '价格范围',
  `category` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_inplacefee` (
  `id` char(15) COLLATE utf8mb4_bin NOT NULL,
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_inplacefeeformat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inplacefeeid` char(36) COLLATE utf8mb4_bin NOT NULL,
  `producttierId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `standard` bit(1) DEFAULT NULL,
  `format` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `description` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1126588419 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='利润计算';
...
CREATE TABLE IF NOT EXISTS `t_inventory_report` (
  ...
  `byday` datetime DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `fnsku` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `pcondition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `your_price` decimal(10,2) DEFAULT NULL,
  `mfn_listing_exists` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `mfn_fulfillable_quantity` int(11) DEFAULT NULL,
  `afn_listing_exists` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_inventory_report_his` (
  ...
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL,
  `byday` date NOT NULL,
  `marketplaceid` char(20) COLLATE utf8mb4_bin NOT NULL,
  `fnsku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `pcondition` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `your_price` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_inventory_status` (
  `id` bigint(20) unsigned NOT NULL,
  `stockStatus` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `byday` date DEFAULT NULL,
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `marketplaceid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonAuthId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_inventory_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `warehouse` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_orders_financial` (
  ...
  `amazon_order_id` varchar(30) COLLATE utf8mb4_bin NOT NULL COMMENT '订单ID',
  `order_item_id` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单Item id',
  `sku` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SKU',
  `currency` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '货币',
  `ftype` char(240) COLLATE utf8mb4_bin NOT NULL COMMENT '费用类型',
  `amount` decimal(10,2) DEFAULT '0.00' COMMENT '费用',
  `opttime` datetime DEFAULT NULL COMMENT '操作时间',
  `marketplaceId` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '站点',
  `posted_date` datetime DEFAULT NULL COMMENT '出账时间',
  PRIMARY KEY (`id`),
  KEY `amazon_order_id` (`amazon_order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=124104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_orders_remark` (
  `amazon_order_id` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  ...
  `invoice_no` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `credit_note` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `remark` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `operator` bigint(20) unsigned DEFAULT NULL,
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`amazon_order_id`),
...
CREATE TABLE IF NOT EXISTS `t_orders_report` (
  `id` bigint(20) unsigned NOT NULL,
  `amazon_order_id` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  `merchant_order_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `purchase_date` datetime NOT NULL,
  `last_updated_date` datetime DEFAULT NULL,
  `order_status` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillment_channel` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `sales_channel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `order_channel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `url` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_service_level` varchar(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `sku` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `item_status` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `currency` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `item_price` decimal(10,2) DEFAULT NULL,
  `item_tax` decimal(10,2) DEFAULT NULL,
  ...
  `item_promotion_discount` decimal(10,2) DEFAULT NULL,
  `ship_promotion_discount` decimal(10,2) DEFAULT NULL,
  `ship_city` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_state` char(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_postal_code` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_country` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `promotion_ids` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `is_business_order` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `purchase_order_number` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `price_designation` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  `marketplaceId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_orders_report_download` (
  ...
  `item_promotion_discount` decimal(10,2) DEFAULT NULL,
  `ship_promotion_discount` decimal(10,2) DEFAULT NULL,
  `ship_city` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_state` char(60) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_postal_code` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `ship_country` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `promotion_ids` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_orders_sumconfig` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL,
  `order_status` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_orders_summary` (
  `id` bigint(20) unsigned NOT NULL,
  `amazonAuthId` bigint(20) unsigned NOT NULL,
  `marketplaceid` char(25) COLLATE utf8mb4_bin NOT NULL,
  `purchase_date` date NOT NULL,
  `asin` char(36) COLLATE utf8mb4_bin NOT NULL,
  `sku` char(50) COLLATE utf8mb4_bin NOT NULL,
  `quantity` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_order_invoice` (
  `id` bigint(20) unsigned NOT NULL,
  `groupid` bigint(20) unsigned NOT NULL,
  `logoUrl` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图片地址id',
  ...
  `postalcode` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `email` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `sign` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_order_invoice_vat` (
  ...
  `groupid` bigint(20) unsigned DEFAULT NULL,
  `country` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `vat_num` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_outbound_weightformat` (
  ...
  `producttierId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `isMedia` bit(1) DEFAULT NULL,
  `format` char(255) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_picture` (
  ...
  `url` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图片网络位置',
  `location` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图片本地位置',
  `height` decimal(10,2) DEFAULT NULL COMMENT '图片高度',
  `height_units` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '高度单位',
  `width` decimal(10,2) DEFAULT NULL COMMENT '图片宽度',
  `width_units` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '宽度单位',
  `opttime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_product_category` (
  `CategoryId` char(50) COLLATE utf8mb4_bin NOT NULL,
  `pid` bigint(20) unsigned NOT NULL,
  `Name` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `parentId` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_follow` (
  `id` bigint(20) unsigned NOT NULL,
  `asin` char(18) COLLATE utf8mb4_bin DEFAULT NULL,
  `amazonAuthId` bigint(20) unsigned DEFAULT NULL,
  `marketplaceid` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_info` (
  ...
  `asin` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '唯一码asin',
  `sku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户码sku',
  `marketplaceid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '站点',
  `name` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品名称（产品标题）',
  `openDate` datetime DEFAULT NULL COMMENT '创建日期',
  `itemDimensions` bigint(20) unsigned DEFAULT NULL COMMENT '产品尺寸',
  `pageDimensions` bigint(20) unsigned DEFAULT NULL COMMENT '含包装尺寸',
  `fulfillChannel` varchar(120) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交付渠道',
  `binding` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '装订',
  `totalOfferCount` int(11) DEFAULT NULL COMMENT '卖家数量',
  `brand` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌',
  `manufacturer` varchar(250) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '厂商',
  `pgroup` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '分组',
  `typename` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '分类',
  `price` decimal(14,2) DEFAULT NULL COMMENT '价格',
  `image` bigint(20) unsigned DEFAULT NULL COMMENT '照片',
  `parentMarketplace` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父商品marketplace',
  `parentAsin` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父商品asin',
...
CREATE TABLE IF NOT EXISTS `t_product_info_follow` (
  `pid` bigint(20) unsigned NOT NULL,
  `status_upload` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_in_opt` (
  ...
  `priceremark` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '价格公告',
  `buyprice` decimal(10,2) DEFAULT NULL COMMENT '采购单价',
  `businessprice` decimal(10,2) DEFAULT NULL COMMENT '销售价格',
  `businesstype` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '价格',
  `businesslist` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '隐藏',
  `disable` bit(1) DEFAULT b'0' COMMENT '手动输入的预估销量',
  `presales` int(11) DEFAULT NULL COMMENT '手动输入的预估销量',
  `lastupdate` datetime DEFAULT NULL COMMENT '更新时间',
  `remark_analysis` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `msku` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '本地SKU',
  `fnsku` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'FNSKU',
  `review_daily_refresh` int(11) DEFAULT NULL COMMENT '评论刷新时间',
  `fulfillment_availability` int(11) DEFAULT NULL COMMENT '自发货可用库存',
  `merchant_shipping_group` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '自发货运费模板',
...
CREATE TABLE IF NOT EXISTS `t_product_in_presale` (
  ...
  `month` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_in_profit` (
  ...
  `planName` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `dimensions` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `lastupdate` datetime DEFAULT NULL,
  `shipmentfee` decimal(10,2) DEFAULT NULL,
  `othersfee` decimal(10,2) DEFAULT NULL,
  `costDetail` varchar(2000) COLLATE utf8mb4_bin DEFAULT '',
  PRIMARY KEY (`pid`),
  KEY `lastupdate` (`lastupdate`)
...
CREATE TABLE IF NOT EXISTS `t_product_in_review` (
  ...
  `positiveReview` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `criticalReview` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `refreshtime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_in_review_detail` (
  ...
  `review_body` varchar(4000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_price` (
  ...
  `asin` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `byday` datetime DEFAULT NULL,
  `ptype` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `landed_amount` decimal(10,2) DEFAULT NULL,
  `landed_currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `listing_amount` decimal(10,2) DEFAULT NULL,
  `listing_currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `shipping_amount` decimal(10,2) DEFAULT NULL,
  `shipping_currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `isnewest` bit(1) DEFAULT NULL,
  `fulfillmentChannel` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `itemCondition` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `itemSubCondition` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `SellerId` char(15) COLLATE utf8mb4_bin DEFAULT NULL,
  `SellerSKU` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_product_price_his` (
  ...
  `asin` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `byday` datetime DEFAULT NULL,
  `ptype` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `landed_amount` decimal(10,2) DEFAULT NULL,
  `landed_currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `listing_amount` decimal(10,2) DEFAULT NULL,
  `listing_currency` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_rank` (
  `id` bigint(20) unsigned NOT NULL,
  `byday` datetime DEFAULT NULL,
  `categoryId` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `rank` int(11) DEFAULT NULL,
  `product_id` bigint(20) unsigned DEFAULT NULL,
  `title` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `link` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_product_rank_sales_his` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `market` char(5) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_product_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类型',
...
CREATE TABLE IF NOT EXISTS `t_product_usercategory` (
  `id` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `name` char(36) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_profitcfg` (
  ...
  `sales_channel` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '配送方案，是否亚马逊配送',
  `sellerPlan` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售计划',
  `shipmentStyle` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT '运费计算方式',
...
CREATE TABLE IF NOT EXISTS `t_profitcfgcountry` (
  ...
  `country` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '国家',
  ...
  `logistics` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物流方式',
  ...
  `invplacefee` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '库存配置费',
  ...
  `warehouse_site` char(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '当配送方案为EFN时，亚马逊仓库站点',
  `dispatch_type` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '亚马逊配送方案:pan_EU,EFN',
...
CREATE TABLE IF NOT EXISTS `t_referralfee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类型',
  `isMedia` char(1) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '是否媒介',
...
CREATE TABLE IF NOT EXISTS `t_report_requestrecord` (
  ...
  `reportType` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `reportRequestId` bigint(20) unsigned DEFAULT NULL,
  `reportDocumentId` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `startDate` datetime DEFAULT NULL,
  `endDate` datetime DEFAULT NULL,
  `isnewest` bit(1) DEFAULT NULL,
  ...
  `lastupdate` datetime DEFAULT NULL,
  `report_processing_status` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `log` longtext CHARACTER SET utf8 COLLATE utf8_bin,
  `reportOptions` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=11989481307546005070 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_summaryall` (
  ...
  `sales_channel` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `order_status` char(30) COLLATE utf8mb4_bin DEFAULT NULL,
  `fulfillChannel` char(15) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交付渠道',
  `discount` char(1) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `is_business_order` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `quantity` decimal(32,0) DEFAULT NULL,
  `ordernumber` bigint(20) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_sys_operationlog` (
  ...
  `ip` char(35) COLLATE utf8mb4_bin DEFAULT NULL,
  `userid` bigint(20) unsigned DEFAULT NULL,
  `username` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `logType` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `method` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `exceptionDetail` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `param` varchar(4000) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_variable_closing_fee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `country` char(3) COLLATE utf8mb4_bin DEFAULT NULL,
  `typeid` int(11) DEFAULT NULL,
  `isMedia` char(1) COLLATE utf8mb4_bin DEFAULT NULL,
  `logisticsId` char(10) COLLATE utf8mb4_bin DEFAULT '0',
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `format` char(255) COLLATE utf8mb4_bin DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `country` (`country`),
