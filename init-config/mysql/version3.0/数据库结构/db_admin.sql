...
CREATE TABLE IF NOT EXISTS `t_manager_limit` (
  ...
  `shopId` bigint(20) unsigned DEFAULT NULL,
  `maxShopCount` int(11) DEFAULT '10' COMMENT '绑定店铺数量',
  `maxMarketCount` int(11) DEFAULT '10' COMMENT '绑定店铺站点数量',
  `maxProductCount` int(11) DEFAULT '50000' COMMENT '商品数量上限',
  `maxOrderCount` int(11) DEFAULT '3600' COMMENT '处理订单上限',
  `maxMember` int(11) DEFAULT '3' COMMENT '子用户数量上限',
  `maxProfitPlanCount` int(11) DEFAULT '1' COMMENT '利润计算方案数量',
  `maxdayOpenAdvCount` int(11) DEFAULT '10' COMMENT '每天开启广告组数量',
  `existShopCount` int(11) DEFAULT '0',
  `existMarketCount` int(11) DEFAULT '0',
  `existProductCount` int(11) DEFAULT '0',
  `existOrderCount` int(11) DEFAULT '0',
  `existMember` int(11) DEFAULT '0',
  `existProfitPlanCount` int(11) DEFAULT '0',
  `existdayOpenAdvCount` int(11) DEFAULT '0',
  `tariffpackage` int(11) DEFAULT '0' COMMENT '0-基础版，1-标准版，2-专业版，3-独享版,4-自定义',
  ...
  `saleskey` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_menu` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '主键(h)',
  ...
  `parentid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父菜单',
  `icon` varchar(2048) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图标',
  `childnumber` int(11) DEFAULT NULL COMMENT '子菜单个数',
  `action_url` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '页面链接',
  `groupid` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '分组',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_role` (
  `id` bigint(20) unsigned NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '角色名称',
  `type` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '角色类型',
...
CREATE TABLE IF NOT EXISTS `t_role_authority` (
  ...
  `authority_id` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_role_menu` (
  ...
  `menu_id` char(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '菜单ID',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_shop` (
  `id` bigint(20) unsigned NOT NULL,
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '公司名称',
  `remark` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `invitecode` char(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '邀请码',
  `fromcode` char(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '受邀请码',
  `oldid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `boss_email` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_sys_customer_discount` (
  `id` bigint(20) unsigned NOT NULL,
  `number` char(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '折扣编码',
  ...
  `account` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '指定应用帐户（可以不填）',
  `pkgtime` int(11) DEFAULT NULL,
  `isused` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否应用',
  `orderid` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '应用订单',
  `shopid` bigint(20) unsigned DEFAULT NULL COMMENT '应用公司',
  `createdate` datetime DEFAULT NULL COMMENT '创建时间',
  `lostime` datetime DEFAULT NULL COMMENT '失效时间',
  `operator` varchar(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作人',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_sys_customer_order` (
  ...
  `ftype` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单类型  package:套餐  append:附加包',
  `out_trade_no` char(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商户订单号',
  `subject` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单名称',
  `trade_no` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '支付宝交易号',
  `total_amount` decimal(10,2) DEFAULT NULL COMMENT '付款金额',
  `discountnumber` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `paytime` timestamp NULL DEFAULT NULL,
  `paystatus` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '付款状态',
  `ivcstatus` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '开票状态',
  `months` int(11) DEFAULT NULL,
  `tariffpackage` int(11) DEFAULT NULL,
  `pcs` int(11) DEFAULT '1',
  `paytype` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_customer_order_refund` (
  ...
  `refund_reason` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单名称',
  `out_request_no` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `opttime` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT=' ';
...
CREATE TABLE IF NOT EXISTS `t_sys_dict` (
  ...
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '类型名称',
  `code` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '类型编码',
...
CREATE TABLE IF NOT EXISTS `t_sys_dict_item` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '字典项名称',
  `value` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '字典项值',
  `dict_code` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '字典编码',
...
CREATE TABLE IF NOT EXISTS `t_sys_feishu_auth` (
  `app_id` char(36) COLLATE utf8mb4_bin NOT NULL,
  `app_secret` char(36) COLLATE utf8mb4_bin NOT NULL,
  `encrypt_key` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `verification_token` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `shopid` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_help_page` (
  ...
  `menuid` char(36) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_holiday` (
  ...
  `value` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_sys_importrecord` (
  ...
  `shopid` bigint(20) unsigned DEFAULT NULL,
  `importtype` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_menu` (
  ...
  `name` varchar(64) COLLATE utf8mb4_bin DEFAULT '' COMMENT '菜单名称',
  `parent_id` bigint(20) DEFAULT NULL COMMENT '父菜单ID',
  `apppath` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `path` varchar(128) COLLATE utf8mb4_bin DEFAULT '' COMMENT '路由路径',
  `component` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '组件路径',
  `icon` varchar(64) COLLATE utf8mb4_bin DEFAULT '' COMMENT '菜单图标',
  `appicon` varchar(64) COLLATE utf8mb4_bin DEFAULT '',
  `sort` int(11) DEFAULT '0' COMMENT '排序',
  `visible` tinyint(1) DEFAULT '1' COMMENT '状态：0-禁用 1-开启',
  `redirect` varchar(128) COLLATE utf8mb4_bin DEFAULT '' COMMENT '跳转路径',
  `runui` bit(1) DEFAULT NULL,
  `runapp` bit(1) DEFAULT NULL,
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  `oldid` char(40) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=101216 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='菜单管理';
...
CREATE TABLE IF NOT EXISTS `t_sys_message_template` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ftype` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT '消息类型',
...
CREATE TABLE IF NOT EXISTS `t_sys_notify` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `content` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL,
  `ftype` int(11) NOT NULL COMMENT '消息的类型，1: 公告 Announce，2: 提醒 Remind，3：信息 Message',
  `target` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '目标类型',
  `action` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '提醒信息的动作类型',
  ...
  KEY `shopid` (`shopid`),
  KEY `target` (`target`)
) ENGINE=InnoDB AUTO_INCREMENT=2116481026 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_sys_permission` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '权限名称',
  `menu_id` int(11) DEFAULT NULL COMMENT '菜单模块ID\r\n',
  `url_perm` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'URL权限标识',
  `btn_perm` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '按钮权限标识',
  `gmt_create` datetime DEFAULT NULL,
  `gmt_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id` (`id`,`name`),
  KEY `id_2` (`id`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1697438074115891203 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=38005 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_sys_query_field` (
  `fquery` char(20) COLLATE utf8mb4_bin NOT NULL,
  `ffield` char(30) COLLATE utf8mb4_bin NOT NULL,
  `title` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `titleTooltip` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `width` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `findex` int(11) DEFAULT NULL,
  `formatter` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `footerFormatter` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `sortable` bit(1) DEFAULT NULL,
  `valign` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `align` char(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_query_user_version` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `userid` bigint(20) unsigned DEFAULT NULL,
  `fquery` char(20) COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=123457031 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_sys_subscription` (
  `target` char(2) COLLATE utf8mb4_bin NOT NULL,
  `userid` bigint(20) unsigned NOT NULL,
  `action` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订阅动作',
...
CREATE TABLE IF NOT EXISTS `t_sys_tags` (
  ...
  `name` char(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '标签名称',
  `value` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `sort` int(11) DEFAULT NULL,
  `color` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_tags_groups` (
  ...
  `description` char(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `creator` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sys_target` (
  `id` char(2) COLLATE utf8mb4_bin NOT NULL,
  `name` char(50) COLLATE utf8mb4_bin NOT NULL,
  `description` char(100) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_sys_tariff_packages` (
  ...
  `name` char(36) COLLATE utf8mb4_bin NOT NULL COMMENT '套餐名字',
  ...
  `orderMemoryCount` char(10) COLLATE utf8mb4_bin NOT NULL DEFAULT '3' COMMENT '订单存储时间 单位:月  默认基础版是3个月',
  ...
  `lastUpdateUser` varchar(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最后更新的人',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `t_sys_timetask` (
  ...
  `group_name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '任务组',
  `start_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `cron` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '表达式',
  `job_status` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '发布状态',
  `plan_status` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '计划状态',
  `is_concurrent` int(11) DEFAULT NULL COMMENT '运行状态',
  `job_data` longtext COLLATE utf8mb4_bin COMMENT '参数',
  `menthod_name` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '方法',
  `bean_name` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '实例bean',
  `description` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '任务描述',
  `creator` bigint(20) unsigned DEFAULT NULL COMMENT '创建人',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `t_sys_timetask_log` (
  `id` char(36) COLLATE utf8mb4_bin NOT NULL,
  `createdate` datetime DEFAULT NULL,
  `job_id` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `state` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `t_sys_user_datalimit` (
  `userid` bigint(20) unsigned NOT NULL,
  `datatype` char(15) COLLATE utf8mb4_bin NOT NULL COMMENT 'owner只能查看自己负责的产品（在产品管理页面配置）;operations只能查看自己运营的产品（在商品分析页面配置）',
...
CREATE TABLE IF NOT EXISTS `t_sys_user_ip_city` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `userip` char(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `city` char(20) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_sys_weather` (
  `id` bigint(20) unsigned NOT NULL,
  `city` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '城市',
  `weatype` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '值:多云 晴 小雨 大雨',
  `updatedate` datetime DEFAULT NULL COMMENT '当前日期的天气',
  `nowdegree` int(11) DEFAULT NULL COMMENT '当前温度 ''C',
  `lowdegree` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最低温度',
  `highdegree` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最高温度',
  `weaforce` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '风向',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_tasklock` (
  `task` char(15) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_user` (
  ...
  `salt` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `member` int(11) DEFAULT '5' COMMENT '拥有下属数量上限',
  `passwordkey` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `lastlogintime` datetime DEFAULT NULL,
  `lastloginip` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `lastloginsession` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `ftype` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `oldid` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_userinfo` (
  ...
  `picture` char(36) COLLATE utf8mb4_bin DEFAULT NULL,
  `tel` varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
