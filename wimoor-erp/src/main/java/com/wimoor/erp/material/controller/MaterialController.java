...
public class MaterialController {
	   ...
	   final IMaterialSupplierService iMaterialSupplierService;
	    ...
	    public Result<IPage<Map<String, Object>>> list(@RequestBody MaterialDTO dto) {
			...
			key=key+dto.getCurrentpage();
			key=key+dto.getPagesize();
			key=key+(dto.getSort()!=null?dto.getSort():"");
			key=key+(dto.getOrder()!=null?dto.getOrder():"");
	        IPage<Map<String, Object>> result = iMaterialService.findByCondition(dto.getPage(),map,key);
