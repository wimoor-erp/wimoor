...
public interface PurchaseFormMapper extends BaseMapper<PurchaseForm> {
	...
	IPage<Map<String, Object>> selectByConditionNew(Page<?> page,Map<String, Object> param);
	...
	List<Map<String, Object>> getPayRecSumReport(Map<String, Object> param);
	...
	Map<String, Object> selectPurchaseNumAllStatus(Map<String, Object> param);
