...
public interface WarehouseShelfInventoryMapper extends BaseMapper<WarehouseShelfInventory> {
	...
	List<WarehouseShelfInventoryVo> findByMaterial(@Param("shopid")String shopid,@Param("warehouseid")String warehouseid,@Param("materialid")String materialid);
	public IPage<WarehouseShelfInventoryVo> getShelfList(Page<?> page,@Param("param") Map<String, Object> param);
