...
public class WarehouseController {
	...
	public Result<Map<String,Object>> updateStockAction(String materialid,String warehouseid,String cycle,String mincycle){
		Map<String,Object> map = new HashMap<String, Object>();
		Map<String,Object> param = new HashMap<String, Object>();
		UserInfo userinfo = UserInfoContext.get();
		boolean result = false;
		param.put("num", cycle);
		param.put("mincycle", mincycle);
		param.put("materialid", materialid);
		param.put("warehouseid", warehouseid);
		if(warehouseid != null){
			result=iStockCycleService.updateStockCycle(param, userinfo);
		}
		if(result==true){
			map.put("msg", "操作成功");
