...
public interface ShipPlanItemMapper extends BaseMapper<ShipPlanItem> {
	...
	List<Map<String, Object>> checkInventory(@Param("groupid")String groupid,@Param("warehouseid")String warehouseid);
	
	List<Map<String, Object>> checkInventoryAssembly(@Param("groupid")String groupid,@Param("warehouseid")String warehouseid);
}